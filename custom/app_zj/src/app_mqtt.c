...
static int app_mqtt_pub_uploadDevSN(app_cfg_t *ctx)
{
    ...
    app_util_jsonDataPack(false, &m_sendLen, ATTR_STRING, "batteryLeft", (unsigned char *)mbat_str);
    ...
    app_util_jsonDataPack(false, &m_sendLen, ATTR_STRING, "cellularStrength", (unsigned char *)signalLevel);
