...
static int app_gps_getGnssData(int iTimeout, app_cfg_t *pApp)
{
    int iRet = MG_RET_ERR;
    int i = iTimeout/(1000);
    MG_TRACE_Printf((u32)((u32)('U') | ((u32)('S') << 7) | ((u32)('E') << 14) | ((u32)('R') << 21)), "[%d]GPS get gnss data", 55);
    ...
    do
    {
        ...
        {
            MG_TRACE_Printf((u32)((u32)('U') | ((u32)('S') << 7) | ((u32)('E') << 14) | ((u32)('R') << 21)), "[%d]GPS get gnss data", 68);
            MG_GNSS_Open();
        }
        else
        {
            MG_TRACE_Printf((u32)((u32)('U') | ((u32)('S') << 7) | ((u32)('E') << 14) | ((u32)('R') << 21)), "[%d]GPS get gnss data", 74);
            memset(&nmeaINFO, 0, sizeof(nmeaINFO));
            MG_GNSS_GetNmeaInfo((u8 *)gnss_str, sizeof(gnss_str));
            if (MG_GNSS_NmeaParse((u8 *)gnss_str, &nmeaINFO) == 1)
            {
                if (nmeaINFO.sig)
                {
                    ST_Time m_time;
                    MG_TRACE_Printf((u32)((u32)('U') | ((u32)('S') << 7) | ((u32)('E') << 14) | ((u32)('R') << 21)), "[%d]GPS get gnss data", 91);
                    MG_TRACE_Printf((u32)((u32)('U') | ((u32)('S') << 7) | ((u32)('E') << 14) | ((u32)('R') << 21)), "[%d]GPS get gnss data, lat:%d, lon:%d", 92, (int)nmeaINFO.lat*1000000, (int)nmeaINFO.lon*1000000);
...
static int _app_lbs_httpGet(app_cfg_t *pApp, const char *url, u32 timeout_s)
{
    ...
    if (MG_RET_OK == iRet)
    {
        ...
        if (1 == _app_lbs_getPos(g_app_tmpBuff, latitude, longtitude))
        {
            ...
            char evl_null[] = "0.0";
            char speed_null[] = "0.0";
            MG_TRACE_Printf((u32)((u32)('U') | ((u32)('S') << 7) | ((u32)('E') << 14) | ((u32)('R') << 21)), "[%d]LBS get gnss data, latitude:%s, longtitude:%s", 285, latitude, longtitude);
            ...
            MG_TRACE_Printf((u32)((u32)('U') | ((u32)('S') << 7) | ((u32)('E') << 14) | ((u32)('R') << 21)), "[%d]LBS modify to string, lat:%s, lon:%s", 294, pApp->gnssData.lat,pApp->gnssData.lon);
...
int app_gps_getLBSData(int iTimeout, app_cfg_t *pApp)
{
    ...
    if (iRet == MG_RET_OK)
    {
        ...
        MG_TRACE_Printf((u32)((u32)('U') | ((u32)('S') << 7) | ((u32)('E') << 14) | ((u32)('R') << 21)), "[%d]LBS URL: %s", 356, url);
...
void app_gps_init(void)
{
    ...
    MG_TRACE_Printf((u32)((u32)('U') | ((u32)('S') << 7) | ((u32)('E') << 14) | ((u32)('R') << 21)), "[%d]GPS init gps ant, %d", 382, bRet);
}
