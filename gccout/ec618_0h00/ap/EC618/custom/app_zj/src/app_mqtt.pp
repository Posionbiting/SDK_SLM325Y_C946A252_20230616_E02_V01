...
#define __CURRENT_FILE_NAME__ app_mqtt
#define __EC618 1
#define CHIP_EC618 1
#define CORE_IS_AP 1
...
#define FDSETSAFESET(n,code) do { if (((n) - SOCKET_OFFSET < NUM_NETCONN) && (((s32)(n) - SOCKET_OFFSET) >= 0)) { code; }} while(0)
#define FDSETSAFEGET(n,code) (((n) - SOCKET_OFFSET < NUM_NETCONN) && (((s32)(n) - SOCKET_OFFSET) >= 0) ? (code) : 0)
...
#define FD_ZERO(p) (__extension__ (void)({ s32 __i; char *__tmp = (char *)p; for (__i = 0; __i < sizeof (*(p)); ++__i) *__tmp++ = 0; }))
...
#define UNITY_LIST_STRUCT_MEMBERS s32 headFlag; struct _UnityList *prev; struct _UnityList *next;
typedef struct _UnityList {
    s32 headFlag; struct _UnityList *prev; struct _UnityList *next;
} ST_UnityList;
...
static inline _Bool MCI_MutexLock(MCI_Mutex *mutex)
{
    return MG_OS_MutexLock((ST_Mutex *)mutex, (0xFFFFFFFFU));
}
...
static inline _Bool MCI_ThreadEventSend(MCI_Thread *thread, MCI_Event *event, s32 timeout)
{
    return MG_OS_EventSend((ST_Thread *)thread, (ST_Event *)event, timeout);
}
static inline _Bool MCI_ThreadEventWait(MCI_Thread *thread, MCI_Event *event, s32 timeout)
{
...
static inline _Bool MCI_SemaphoreAcquire(MCI_Semaphore *sem, s32 timeout)
{
...
#define MQTT_DO_WHILE0(expr) do { expr } while (0)
...
#define NETWORK_PDP_TYPE_IP 1
#define NETWORK_PDP_TYPE_IPV6 2
#define NETWORK_PDP_TYPE_IPV4V6 3
#define NETWORK_PDP_TYPE_PRIMARY_DNS_IP 1
#define NETWORK_PDP_TYPE_SECONDARY_DNS_IP 2
#define NETWORK_AUTHTYPE_NULL 0
#define NETWORK_AUTHTYPE_PAP 1
#define NETWORK_AUTHTYPE_CHAP 2
#define NETWORK_SWITCH_FLIGHT_MODE_TIMEOUT_MIN_MS (30*1000)
#define NETWORK_FLIGHT_MODE 0
#define NETWORK_NORMAL_MODE 1
#define NETWORK_RAT_TYPE_GSM 2
#define NETWORK_RAT_TYPE_LTE 4
#define NETWORK_NEIGHBOR_CELL_NUM_MAX 6
#define OPERATOR_LONG_FORMAT_ALPHANUMERIC 0
#define OPERATOR_SHORT_FORMAT_ALPHANUMERIC 1
#define OPERATOR_NUMERIC 2
#define OPERATOR_LONG_FORMAT_ALPHANUMERIC_MAX_LEN 17
#define OPERATOR_SHORT_FORMAT_ALPHANUMERIC_MAX_LEN 9
#define OPERATOR_NUMERIC_MAX_LEN 6
...
typedef struct _NwNeighborCellInfo
{
    ...
    union
    {
        ST_NwGSMNeighborCellInfo gsm[6];
        ST_NwLTENeighborCellInfo lte[6];
    } u_CellInfo;
    u8 netType;
...
s32 MG_TIMER_Start(ST_Timer *timer, u32 ms, _Bool autoRepeat);
s32 MG_TIMER_StartLowPower(ST_Timer *timer, u32 ms, _Bool autoRepeat);
s32 MG_TIMER_Stop(ST_Timer *timer);
s32 MG_TIMER_Delete(ST_Timer *timer);
#define _MG_PM_H_ 
#define PM_ENTER_SLEEP_DELAY_MS (500)
#define PM_SLEEP_MODE_0 0
#define PM_SLEEP_MODE_1 1
#define PM_SLEEP_LOG_OUTPUT_NO 0
#define PM_SLEEP_LOG_OUTPUT_UART 1
#define PM_SLEEP_LOG_OUTPUT_USB 2
...
static int app_mqtt_pub_uploadDevSN(app_cfg_t *ctx)
{
    ...
    float batteryLeft = 100*(g_app_cfg.nvConfig.batterySize-g_app_cfg.nvConfig.batteryCount*350)/g_app_cfg.nvConfig.batterySize;
    int mbat = (int)(batteryLeft + 0.5);
    if(mbat>100)
        mbat = 100;
    if(mbat<0)
        mbat = 0;
    MG_TRACE_Printf((u32)((u32)('U') | ((u32)('S') << 7) | ((u32)('E') << 14) | ((u32)('R') << 21)), "[%d]hyj battery, consume:%.2f", 124, batteryLeft);
    app_util_jsonDataPack(1, &m_sendLen, ATTR_STRING, "deviceSn", (unsigned char *)ctx->nvConfig.sn);
    app_util_jsonDataPack(0, &m_sendLen, ATTR_STRING, "time", (unsigned char *)ctx->gnssData.utc);
    app_util_jsonDataPack(0, &m_sendLen, ATTR_INT, "batteryLeft", (unsigned char *)&mbat);
    app_util_jsonDataPack(0, &m_sendLen, ATTR_STRING, "cellularType", (unsigned char *)_app_netTypeToString(ctx->netInfo.netType));
    app_util_jsonDataPack(0, &m_sendLen, ATTR_INT, "cellularStrength", (unsigned char *)&ctx->netInfo.signalLevel);
    app_util_jsonDataPack(0, &m_sendLen, ATTR_STRING, "lat", (unsigned char *)ctx->gnssData.lat);
    app_util_jsonDataPack(0, &m_sendLen, ATTR_STRING, "lon", (unsigned char *)ctx->gnssData.lon);
    app_util_jsonDataPack(0, &m_sendLen, ATTR_STRING, "altitude", (unsigned char *)ctx->gnssData.elv);
    app_util_jsonDataPack(0, &m_sendLen, ATTR_STRING, "speed", (unsigned char *)ctx->gnssData.speed);
    app_util_jsonDataPack(0, &m_sendLen, ATTR_INT, "satellitesNum", (unsigned char *)&ctx->gnssData.view);
    ...
    MG_TRACE_Printf((u32)((u32)('U') | ((u32)('S') << 7) | ((u32)('E') << 14) | ((u32)('R') << 21)), "[%d]MQTT pub uploadDevSN, iRet:%d", 167, iRet);
    return iRet;
}
void app_get_ParamSet(const u8 *data, u32 date_len)
{
    ...
    if(root == ((void *)0))
    {
        MG_TRACE_Printf((u32)((u32)('U') | ((u32)('S') << 7) | ((u32)('E') << 14) | ((u32)('R') << 21)), "[%d]MQTT download param err", 179);
        return;
    }
    item = cJSON_GetObjectItem(root, "settingId");
    if (item && item->type == (1 << 4))
    {
    ...
    MG_TRACE_Printf((u32)((u32)('U') | ((u32)('S') << 7) | ((u32)('E') << 14) | ((u32)('R') << 21)), "[%d]MQTT get paramSet samplingPeriod:%d", 209, g_app_cfg.nvConfig.nReportCycle);
}
static int app_pub_ParamSet(app_cfg_t *ctx)
{
    ...
    memset(g_app_tmpBuff, 0, sizeof(g_app_tmpBuff));
    m_sendLen += sprintf(g_app_tmpBuff+m_sendLen, "{");
    app_util_jsonDataPack(1, &m_sendLen, ATTR_STRING, "settingId", (unsigned char *)settingId);
    ...
    app_util_jsonDataPack(0, &m_sendLen, ATTR_STRING, "time", (unsigned char *)ctx->gnssData.utc);
    MG_TRACE_Printf((u32)((u32)('U') | ((u32)('S') << 7) | ((u32)('E') << 14) | ((u32)('R') << 21)), "[%d]MQTT sub: %s", 230, mTopic7);
    m_sendLen += sprintf(g_app_tmpBuff+m_sendLen, "%s}", mEnd);
    {
        iRet = MG_MQTT_Publish(ctx->mqtt.client, mTopic7,
                               (u8 *)g_app_tmpBuff, strlen(g_app_tmpBuff),
                               (0), (1), (0), ctx->mqtt.requestTimeout);
    }
    MG_TRACE_Printf((u32)((u32)('U') | ((u32)('S') << 7) | ((u32)('E') << 14) | ((u32)('R') << 21)), "[%d]MQTT pub ParamSet, iRet:%d", 240, iRet);
    return iRet;
}
void app_get_ParamQuery(const u8 *data, u32 date_len)
{
    ...
    if(root == ((void *)0))
    {
        MG_TRACE_Printf((u32)((u32)('U') | ((u32)('S') << 7) | ((u32)('E') << 14) | ((u32)('R') << 21)), "[%d]MQTT get paramQuery err", 252);
        return;
    }
    ...
    MG_TRACE_Printf((u32)((u32)('U') | ((u32)('S') << 7) | ((u32)('E') << 14) | ((u32)('R') << 21)), "[%d]MQTT get paramQuery ", 268);
}
static int app_pub_paramQuery(app_cfg_t *ctx)
{
    ...
    int m_iBuff = 0;
    app_gps_getData(&g_app_cfg);
    app_util_jsonDataPack(1, &m_sendLen, ATTR_STRING, "querySettingId", (unsigned char *)queryId);
    app_util_jsonDataPack(0, &m_sendLen, ATTR_STRING, "deviceSn", (unsigned char *)ctx->nvConfig.sn);
    app_util_jsonDataPack(0, &m_sendLen, ATTR_STRING, "remoteURL", (unsigned char *)"47.89.13.131");
    m_iBuff = 3134;
    app_util_jsonDataPack(0, &m_sendLen, ATTR_INT, "remotePort", (unsigned char *)&m_iBuff);
    m_iBuff = ctx->nvConfig.nReportCycle;
    app_util_jsonDataPack(0, &m_sendLen, ATTR_INT, "gpsInterval", (unsigned char *)&m_iBuff);
    app_util_jsonDataPack(0, &m_sendLen, ATTR_STRING, "time", (unsigned char *)ctx->gnssData.utc);
    MG_TRACE_Printf((u32)((u32)('U') | ((u32)('S') << 7) | ((u32)('E') << 14) | ((u32)('R') << 21)), "[%d]MQTT sub: %s", 291, mTopic8);
    m_sendLen += sprintf(g_app_tmpBuff+m_sendLen, "%s}", mEnd);
    {
    ...
    MG_TRACE_Printf((u32)((u32)('U') | ((u32)('S') << 7) | ((u32)('E') << 14) | ((u32)('R') << 21)), "[%d]MQTT pub paramQuery, iRet:%d", 300, iRet);
    return iRet;
}
void app_get_ParamQF(const u8 *data, u32 date_len)
{
    ...
    if(root == ((void *)0))
    {
        MG_TRACE_Printf((u32)((u32)('U') | ((u32)('S') << 7) | ((u32)('E') << 14) | ((u32)('R') << 21)), "[%d]MQTT get paramQF err", 312);
        return;
    }
    ...
    MG_TRACE_Printf((u32)((u32)('U') | ((u32)('S') << 7) | ((u32)('E') << 14) | ((u32)('R') << 21)), "[%d]MQTT get paramQF", 328);
}
static int app_pub_paramQF(app_cfg_t *ctx)
{
    ...
    unsigned int m_sendLen = 0;
    u8 iccid[21]={0};
    iRet = MG_SIM_GetICCID(0,iccid,21);
    app_gps_getData(&g_app_cfg);
    memset(g_app_tmpBuff, 0, sizeof(g_app_tmpBuff));
    m_sendLen += sprintf(g_app_tmpBuff+m_sendLen, "{");
    ...
    app_util_jsonDataPack(0, &m_sendLen, ATTR_STRING, "time", (unsigned char *)ctx->gnssData.utc);
    MG_TRACE_Printf((u32)((u32)('U') | ((u32)('S') << 7) | ((u32)('E') << 14) | ((u32)('R') << 21)), "[%d]MQTT sub10: %s", 354, mTopic10);
    m_sendLen += sprintf(g_app_tmpBuff+m_sendLen, "%s}", mEnd);
    {
        iRet = MG_MQTT_Publish(ctx->mqtt.client, mTopic10,
                               (u8 *)g_app_tmpBuff, strlen(g_app_tmpBuff),
                               (0), (2), (0), ctx->mqtt.requestTimeout);
    }
    MG_TRACE_Printf((u32)((u32)('U') | ((u32)('S') << 7) | ((u32)('E') << 14) | ((u32)('R') << 21)), "[%d]MQTT pub paramQF, iRet:%d", 364, iRet);
    return iRet;
}
void app_get_ParamBattery(const u8 *data, u32 date_len)
{
    ...
    if(root == ((void *)0))
    {
        MG_TRACE_Printf((u32)((u32)('U') | ((u32)('S') << 7) | ((u32)('E') << 14) | ((u32)('R') << 21)), "[%d]MQTT get paramQF err", 376);
        return;
    }
    ...
    MG_TRACE_Printf((u32)((u32)('U') | ((u32)('S') << 7) | ((u32)('E') << 14) | ((u32)('R') << 21)), "[%d]MQTT get paramBattery", 422);
}
static int app_pub_ParamBattery(app_cfg_t *ctx)
{
    ...
    if(mbat<0)
        mbat = 0;
    int consume = ctx->nvConfig.batteryCount*350;
    memset(g_app_tmpBuff, 0, sizeof(g_app_tmpBuff));
    m_sendLen += sprintf(g_app_tmpBuff+m_sendLen, "{");
    MG_TRACE_Printf((u32)((u32)('U') | ((u32)('S') << 7) | ((u32)('E') << 14) | ((u32)('R') << 21)), "[%d]hyj battery, consume:%.2f", 442, batteryLeft);
    app_util_jsonDataPack(1, &m_sendLen, ATTR_STRING, "settingId", (unsigned char *)settingId);
    app_util_jsonDataPack(0, &m_sendLen, ATTR_INT, "batteryLeft", (unsigned char *)&mbat);
    app_util_jsonDataPack(0, &m_sendLen, ATTR_INT, "batterySize", (unsigned char *)&ctx->nvConfig.batterySize);
    app_util_jsonDataPack(0, &m_sendLen, ATTR_INT, "batteryCount", (unsigned char *)&consume);
    app_util_jsonDataPack(0, &m_sendLen, ATTR_STRING, "confirm", (unsigned char *)"true");
    app_util_jsonDataPack(0, &m_sendLen, ATTR_STRING, "time", (unsigned char *)ctx->gnssData.utc);
    m_sendLen += sprintf(g_app_tmpBuff+m_sendLen, "%s}", mEnd);
    {
    ...
    MG_TRACE_Printf((u32)((u32)('U') | ((u32)('S') << 7) | ((u32)('E') << 14) | ((u32)('R') << 21)), "[%d]MQTT pub ParamBattery, iRet:%d", 459, iRet);
    return iRet;
}
void app_get_downloadParam(const u8 *data, u32 date_len)
{
    ...
    if(root == ((void *)0))
    {
        MG_TRACE_Printf((u32)((u32)('U') | ((u32)('S') << 7) | ((u32)('E') << 14) | ((u32)('R') << 21)), "[%d]MQTT download param err", 472);
        return;
    }
    ...
    MG_TRACE_Printf((u32)((u32)('U') | ((u32)('S') << 7) | ((u32)('E') << 14) | ((u32)('R') << 21)), "[%d]MQTT download param fota_state:%d, url:%s", 511, g_app_cfg.nvConfig.isSysUpdate, g_app_cfg.fotaFileDownloadUrl);
    MG_TRACE_Printf((u32)((u32)('U') | ((u32)('S') << 7) | ((u32)('E') << 14) | ((u32)('R') << 21)), "[%d]MQTT download param samplingPeriod:%d", 512, g_app_cfg.nvConfig.nReportCycle);
}
static int app_pub_ParamOta(app_cfg_t *ctx)
{
    ...
    MG_TRACE_Printf((u32)((u32)('U') | ((u32)('S') << 7) | ((u32)('E') << 14) | ((u32)('R') << 21)), "[%d]MQTT pub ParamOta, iRet:%d", 543, iRet);
    return iRet;
}
static int app_mqtt_sub_paramDown(app_cfg_t *ctx)
{
    int iRet = MG_RET_OK;
    iRet += MG_MQTT_Subscribe(ctx->mqtt.client, mTopic1, (1), ctx->mqtt.requestTimeout);
    MG_TRACE_Printf((u32)((u32)('U') | ((u32)('S') << 7) | ((u32)('E') << 14) | ((u32)('R') << 21)), "[%d]MQTT sub: %s", 553, mTopic1);
    iRet += MG_MQTT_Subscribe(ctx->mqtt.client, mTopic2, (1), ctx->mqtt.requestTimeout);
    MG_TRACE_Printf((u32)((u32)('U') | ((u32)('S') << 7) | ((u32)('E') << 14) | ((u32)('R') << 21)), "[%d]MQTT sub: %s", 555, mTopic2);
    iRet += MG_MQTT_Subscribe(ctx->mqtt.client, mTopic3, (2), ctx->mqtt.requestTimeout);
    MG_TRACE_Printf((u32)((u32)('U') | ((u32)('S') << 7) | ((u32)('E') << 14) | ((u32)('R') << 21)), "[%d]MQTT sub: %s", 557, mTopic3);
    iRet += MG_MQTT_Subscribe(ctx->mqtt.client, mTopic4, (2), ctx->mqtt.requestTimeout);
    MG_TRACE_Printf((u32)((u32)('U') | ((u32)('S') << 7) | ((u32)('E') << 14) | ((u32)('R') << 21)), "[%d]MQTT sub: %s", 559, mTopic4);
    iRet += MG_MQTT_Subscribe(ctx->mqtt.client, mTopic5, (1), ctx->mqtt.requestTimeout);
    MG_TRACE_Printf((u32)((u32)('U') | ((u32)('S') << 7) | ((u32)('E') << 14) | ((u32)('R') << 21)), "[%d]MQTT sub: %s", 561, mTopic5);
    iRet += MG_MQTT_Subscribe(ctx->mqtt.client, mTopica, (1), ctx->mqtt.requestTimeout);
    MG_TRACE_Printf((u32)((u32)('U') | ((u32)('S') << 7) | ((u32)('E') << 14) | ((u32)('R') << 21)), "[%d]MQTT sub: %s", 563, mTopica);
    MG_TRACE_Printf((u32)((u32)('U') | ((u32)('S') << 7) | ((u32)('E') << 14) | ((u32)('R') << 21)), "[%d]MQTT sub topic, iRet:%d", 565, iRet);
    return MG_RET_OK;
}
void app_mqtt_incoming_cb(void *arg, const u8 *topic, u32 topic_len, const u8 *data, u32 date_len)
{
    ...
    MG_TRACE_Printf((u32)((u32)('U') | ((u32)('S') << 7) | ((u32)('E') << 14) | ((u32)('R') << 21)), "[%d]MQTT incoming", 574);
    memcpy(mTopic, (char *)topic, topic_len > 64 ? 64 : topic_len);
    MG_TRACE_Printf((u32)((u32)('U') | ((u32)('S') << 7) | ((u32)('E') << 14) | ((u32)('R') << 21)), "[%d]MQTT date_len:%d, data:%s", 577, date_len , data);
    if(strstr(mTopic, mTopic1))
    {
        MG_TRACE_Printf((u32)((u32)('U') | ((u32)('S') << 7) | ((u32)('E') << 14) | ((u32)('R') << 21)), "[%d]MQTT topic_len:%d, topic:%s", 580, topic_len , mTopic1);
        app_get_ParamSet(data, date_len);
        app_pub_ParamSet(pApp);
    }
    else if(strstr(mTopic, mTopic2))
    {
        MG_TRACE_Printf((u32)((u32)('U') | ((u32)('S') << 7) | ((u32)('E') << 14) | ((u32)('R') << 21)), "[%d]MQTT topic_len:%d, topic:%s", 586, topic_len , mTopic2);
        app_get_ParamQuery(data, date_len);
        app_pub_paramQuery(pApp);
    }
    else if(strstr(mTopic, mTopic3) || strstr(mTopic, mTopic4))
    {
        MG_TRACE_Printf((u32)((u32)('U') | ((u32)('S') << 7) | ((u32)('E') << 14) | ((u32)('R') << 21)), "[%d]MQTT topic_len:%d, topic:%s", 593, topic_len , mTopic3);
        MG_TRACE_Printf((u32)((u32)('U') | ((u32)('S') << 7) | ((u32)('E') << 14) | ((u32)('R') << 21)), "[%d]MQTT topic_len:%d, topic:%s", 594, topic_len , mTopic4);
        app_get_downloadParam(data, date_len);
    }
    else if(strstr(mTopic, mTopic5))
    {
        MG_TRACE_Printf((u32)((u32)('U') | ((u32)('S') << 7) | ((u32)('E') << 14) | ((u32)('R') << 21)), "[%d]MQTT topic_len:%d, topic:%s", 600, topic_len , mTopic5);
        app_get_ParamQF(data, date_len);
        app_pub_paramQF(pApp);
    }
    else if(strstr(mTopic, mTopica))
    {
        MG_TRACE_Printf((u32)((u32)('U') | ((u32)('S') << 7) | ((u32)('E') << 14) | ((u32)('R') << 21)), "[%d]MQTT topic_len:%d, topic:%s", 607, topic_len , mTopica);
...
int app_mqtt_connect(app_cfg_t *ctx)
{
    ...
    MG_TRACE_Printf((u32)((u32)('U') | ((u32)('S') << 7) | ((u32)('E') << 14) | ((u32)('R') << 21)), "[%d]MQTT connect", 622);
    ...
    {
        MG_TRACE_Printf((u32)((u32)('U') | ((u32)('S') << 7) | ((u32)('E') << 14) | ((u32)('R') << 21)), "[%d]MQTT connect, iRet:%d", 635, iRet);
        {
            ctx->mqtt.connectCtx.client_id = (char *)ctx->nvConfig.sn;
            ctx->mqtt.connectCtx.hostname = "47.89.13.131";
            ctx->mqtt.connectCtx.port = 3134;
        ...
        if (MG_RET_OK == iRet)
        {
            MG_TRACE_Printf((u32)((u32)('U') | ((u32)('S') << 7) | ((u32)('E') << 14) | ((u32)('R') << 21)), "[%d]MQTT connect, iRet:%d", 652, iRet);
            iRet = MG_MQTT_RegisterEx(ctx->mqtt.client, app_mqtt_incoming_cb, ((void *)0));
        }
        if (MG_RET_OK == iRet)
        {
            MG_TRACE_Printf((u32)((u32)('U') | ((u32)('S') << 7) | ((u32)('E') << 14) | ((u32)('R') << 21)), "[%d]MQTT connect, iRet:%d", 658, iRet);
        ...
        if(iRet != MG_RET_OK)
        {
            MG_TRACE_Printf((u32)((u32)('U') | ((u32)('S') << 7) | ((u32)('E') << 14) | ((u32)('R') << 21)), "[%d]MQTT connect, iRet:%d", 669, iRet);
...
static void app_slp_beforeSleep(void *pdata, slpManLpState state)
{
    ...
    switch(state)
    {
        case SLPMAN_SLEEP1_STATE:
            MG_TRACE_Printf((u32)((u32)('U') | ((u32)('S') << 7) | ((u32)('E') << 14) | ((u32)('R') << 21)), "[%d]slp_beforeSleep, state:%d", 697, state);
            break;
...
static void app_mqtt_thread(void *param)
{
    ...
    while(1)
    {
        ...
        if (strlen((const char *)pApp->nvConfig.sn) > 0 && pApp->netState == NET_ACTED)
        {
            ...
            if (MG_RET_OK == iRet)
            {
                ...
                MG_TRACE_Printf((u32)((u32)('U') | ((u32)('S') << 7) | ((u32)('E') << 14) | ((u32)('R') << 21)), "[%d]MQTT upload info", 760);
                MG_TRACE_Printf((u32)((u32)('U') | ((u32)('S') << 7) | ((u32)('E') << 14) | ((u32)('R') << 21)), "[%d]MQTT g_app_cfg.nvConfig.isSysUpdate:%d", 761, g_app_cfg.nvConfig.isSysUpdate);
    ...
    MG_TRACE_Printf((u32)((u32)('U') | ((u32)('S') << 7) | ((u32)('E') << 14) | ((u32)('R') << 21)), "[%d]MQTT exit thread", 811);
    app_util_threadSleep(1000, pApp->bLowPowerModeEn);
    MG_OS_ThreadExit();
}
void app_mqtt_task(void)
{
    MG_TRACE_Printf((u32)((u32)('U') | ((u32)('S') << 7) | ((u32)('E') << 14) | ((u32)('R') << 21)), "[%d]MQTT start thread", 818);
    app_gps_init();
