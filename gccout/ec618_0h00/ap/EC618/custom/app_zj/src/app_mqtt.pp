...
static int app_mqtt_pub_uploadDevSN(app_cfg_t *ctx)
{
    ...
    if(mbat<0)
        mbat = 0;
    MG_TRACE_Printf((u32)((u32)('U') | ((u32)('S') << 7) | ((u32)('E') << 14) | ((u32)('R') << 21)), "[%d]hyj battery, consume:%.2f", 122, batteryLeft);
    sprintf(mbat_str, "%d", mbat);
    sprintf(signalLevel, "%d", ctx->netInfo.signalLevel);
    ...
    app_util_jsonDataPack(0, &m_sendLen, ATTR_STRING, "batteryLeft", (unsigned char *)mbat_str);
    app_util_jsonDataPack(0, &m_sendLen, ATTR_STRING, "cellularType", (unsigned char *)_app_netTypeToString(ctx->netInfo.netType));
    app_util_jsonDataPack(0, &m_sendLen, ATTR_STRING, "cellularStrength", (unsigned char *)signalLevel);
    ...
    MG_TRACE_Printf((u32)((u32)('U') | ((u32)('S') << 7) | ((u32)('E') << 14) | ((u32)('R') << 21)), "[%d]MQTT pub uploadDevSN, iRet:%d", 169, iRet);
    return iRet;
}
void app_get_ParamSet(const u8 *data, u32 date_len)
{
    ...
    if(root == ((void *)0))
    {
        MG_TRACE_Printf((u32)((u32)('U') | ((u32)('S') << 7) | ((u32)('E') << 14) | ((u32)('R') << 21)), "[%d]MQTT download param err", 181);
        return;
    }
    ...
    MG_TRACE_Printf((u32)((u32)('U') | ((u32)('S') << 7) | ((u32)('E') << 14) | ((u32)('R') << 21)), "[%d]MQTT get paramSet samplingPeriod:%d", 211, g_app_cfg.nvConfig.nReportCycle);
}
static int app_pub_ParamSet(app_cfg_t *ctx)
{
    ...
    app_util_jsonDataPack(0, &m_sendLen, ATTR_STRING, "time", (unsigned char *)ctx->gnssData.utc);
    MG_TRACE_Printf((u32)((u32)('U') | ((u32)('S') << 7) | ((u32)('E') << 14) | ((u32)('R') << 21)), "[%d]MQTT sub: %s", 232, mTopic7);
    m_sendLen += sprintf(g_app_tmpBuff+m_sendLen, "%s}", mEnd);
    {
    ...
    MG_TRACE_Printf((u32)((u32)('U') | ((u32)('S') << 7) | ((u32)('E') << 14) | ((u32)('R') << 21)), "[%d]MQTT pub ParamSet, iRet:%d", 242, iRet);
    return iRet;
}
void app_get_ParamQuery(const u8 *data, u32 date_len)
{
    ...
    if(root == ((void *)0))
    {
        MG_TRACE_Printf((u32)((u32)('U') | ((u32)('S') << 7) | ((u32)('E') << 14) | ((u32)('R') << 21)), "[%d]MQTT get paramQuery err", 254);
        return;
    }
    ...
    MG_TRACE_Printf((u32)((u32)('U') | ((u32)('S') << 7) | ((u32)('E') << 14) | ((u32)('R') << 21)), "[%d]MQTT get paramQuery ", 270);
}
static int app_pub_paramQuery(app_cfg_t *ctx)
{
    ...
    app_util_jsonDataPack(0, &m_sendLen, ATTR_STRING, "time", (unsigned char *)ctx->gnssData.utc);
    MG_TRACE_Printf((u32)((u32)('U') | ((u32)('S') << 7) | ((u32)('E') << 14) | ((u32)('R') << 21)), "[%d]MQTT sub: %s", 293, mTopic8);
    m_sendLen += sprintf(g_app_tmpBuff+m_sendLen, "%s}", mEnd);
    {
    ...
    MG_TRACE_Printf((u32)((u32)('U') | ((u32)('S') << 7) | ((u32)('E') << 14) | ((u32)('R') << 21)), "[%d]MQTT pub paramQuery, iRet:%d", 302, iRet);
    return iRet;
}
void app_get_ParamQF(const u8 *data, u32 date_len)
{
    ...
    if(root == ((void *)0))
    {
        MG_TRACE_Printf((u32)((u32)('U') | ((u32)('S') << 7) | ((u32)('E') << 14) | ((u32)('R') << 21)), "[%d]MQTT get paramQF err", 314);
        return;
    }
    ...
    MG_TRACE_Printf((u32)((u32)('U') | ((u32)('S') << 7) | ((u32)('E') << 14) | ((u32)('R') << 21)), "[%d]MQTT get paramQF", 330);
}
static int app_pub_paramQF(app_cfg_t *ctx)
{
    ...
    MG_TRACE_Printf((u32)((u32)('U') | ((u32)('S') << 7) | ((u32)('E') << 14) | ((u32)('R') << 21)), "[%d]MQTT pub paramQF, iRet:%d", 366, iRet);
    return iRet;
}
void app_get_ParamBattery(const u8 *data, u32 date_len)
{
    ...
    if(root == ((void *)0))
    {
        MG_TRACE_Printf((u32)((u32)('U') | ((u32)('S') << 7) | ((u32)('E') << 14) | ((u32)('R') << 21)), "[%d]MQTT get paramQF err", 378);
        return;
    }
    ...
    MG_TRACE_Printf((u32)((u32)('U') | ((u32)('S') << 7) | ((u32)('E') << 14) | ((u32)('R') << 21)), "[%d]MQTT get paramBattery", 424);
}
static int app_pub_ParamBattery(app_cfg_t *ctx)
{
    ...
    memset(g_app_tmpBuff, 0, sizeof(g_app_tmpBuff));
    m_sendLen += sprintf(g_app_tmpBuff+m_sendLen, "{");
    MG_TRACE_Printf((u32)((u32)('U') | ((u32)('S') << 7) | ((u32)('E') << 14) | ((u32)('R') << 21)), "[%d]hyj battery, consume:%.2f", 444, batteryLeft);
    app_util_jsonDataPack(1, &m_sendLen, ATTR_STRING, "settingId", (unsigned char *)settingId);
    ...
    MG_TRACE_Printf((u32)((u32)('U') | ((u32)('S') << 7) | ((u32)('E') << 14) | ((u32)('R') << 21)), "[%d]MQTT pub ParamBattery, iRet:%d", 461, iRet);
    return iRet;
}
void app_get_downloadParam(const u8 *data, u32 date_len)
{
    ...
    if(root == ((void *)0))
    {
        MG_TRACE_Printf((u32)((u32)('U') | ((u32)('S') << 7) | ((u32)('E') << 14) | ((u32)('R') << 21)), "[%d]MQTT download param err", 474);
        return;
    }
    ...
    MG_TRACE_Printf((u32)((u32)('U') | ((u32)('S') << 7) | ((u32)('E') << 14) | ((u32)('R') << 21)), "[%d]MQTT download param fota_state:%d, url:%s", 513, g_app_cfg.nvConfig.isSysUpdate, g_app_cfg.fotaFileDownloadUrl);
    MG_TRACE_Printf((u32)((u32)('U') | ((u32)('S') << 7) | ((u32)('E') << 14) | ((u32)('R') << 21)), "[%d]MQTT download param samplingPeriod:%d", 514, g_app_cfg.nvConfig.nReportCycle);
}
static int app_pub_ParamOta(app_cfg_t *ctx)
{
    ...
    MG_TRACE_Printf((u32)((u32)('U') | ((u32)('S') << 7) | ((u32)('E') << 14) | ((u32)('R') << 21)), "[%d]MQTT pub ParamOta, iRet:%d", 545, iRet);
    return iRet;
}
static int app_mqtt_sub_paramDown(app_cfg_t *ctx)
{
    ...
    MG_TRACE_Printf((u32)((u32)('U') | ((u32)('S') << 7) | ((u32)('E') << 14) | ((u32)('R') << 21)), "[%d]MQTT sub: %s", 555, mTopic1);
    iRet += MG_MQTT_Subscribe(ctx->mqtt.client, mTopic2, (1), ctx->mqtt.requestTimeout);
    MG_TRACE_Printf((u32)((u32)('U') | ((u32)('S') << 7) | ((u32)('E') << 14) | ((u32)('R') << 21)), "[%d]MQTT sub: %s", 557, mTopic2);
    iRet += MG_MQTT_Subscribe(ctx->mqtt.client, mTopic3, (2), ctx->mqtt.requestTimeout);
    MG_TRACE_Printf((u32)((u32)('U') | ((u32)('S') << 7) | ((u32)('E') << 14) | ((u32)('R') << 21)), "[%d]MQTT sub: %s", 559, mTopic3);
    iRet += MG_MQTT_Subscribe(ctx->mqtt.client, mTopic4, (2), ctx->mqtt.requestTimeout);
    MG_TRACE_Printf((u32)((u32)('U') | ((u32)('S') << 7) | ((u32)('E') << 14) | ((u32)('R') << 21)), "[%d]MQTT sub: %s", 561, mTopic4);
    iRet += MG_MQTT_Subscribe(ctx->mqtt.client, mTopic5, (1), ctx->mqtt.requestTimeout);
    MG_TRACE_Printf((u32)((u32)('U') | ((u32)('S') << 7) | ((u32)('E') << 14) | ((u32)('R') << 21)), "[%d]MQTT sub: %s", 563, mTopic5);
    iRet += MG_MQTT_Subscribe(ctx->mqtt.client, mTopica, (1), ctx->mqtt.requestTimeout);
    MG_TRACE_Printf((u32)((u32)('U') | ((u32)('S') << 7) | ((u32)('E') << 14) | ((u32)('R') << 21)), "[%d]MQTT sub: %s", 565, mTopica);
    MG_TRACE_Printf((u32)((u32)('U') | ((u32)('S') << 7) | ((u32)('E') << 14) | ((u32)('R') << 21)), "[%d]MQTT sub topic, iRet:%d", 567, iRet);
    return MG_RET_OK;
}
void app_mqtt_incoming_cb(void *arg, const u8 *topic, u32 topic_len, const u8 *data, u32 date_len)
{
    ...
    MG_TRACE_Printf((u32)((u32)('U') | ((u32)('S') << 7) | ((u32)('E') << 14) | ((u32)('R') << 21)), "[%d]MQTT incoming", 576);
    memcpy(mTopic, (char *)topic, topic_len > 64 ? 64 : topic_len);
    MG_TRACE_Printf((u32)((u32)('U') | ((u32)('S') << 7) | ((u32)('E') << 14) | ((u32)('R') << 21)), "[%d]MQTT date_len:%d, data:%s", 579, date_len , data);
    if(strstr(mTopic, mTopic1))
    {
        MG_TRACE_Printf((u32)((u32)('U') | ((u32)('S') << 7) | ((u32)('E') << 14) | ((u32)('R') << 21)), "[%d]MQTT topic_len:%d, topic:%s", 582, topic_len , mTopic1);
        app_get_ParamSet(data, date_len);
        app_pub_ParamSet(pApp);
    }
    else if(strstr(mTopic, mTopic2))
    {
        MG_TRACE_Printf((u32)((u32)('U') | ((u32)('S') << 7) | ((u32)('E') << 14) | ((u32)('R') << 21)), "[%d]MQTT topic_len:%d, topic:%s", 588, topic_len , mTopic2);
        app_get_ParamQuery(data, date_len);
        app_pub_paramQuery(pApp);
    }
    else if(strstr(mTopic, mTopic3) || strstr(mTopic, mTopic4))
    {
        MG_TRACE_Printf((u32)((u32)('U') | ((u32)('S') << 7) | ((u32)('E') << 14) | ((u32)('R') << 21)), "[%d]MQTT topic_len:%d, topic:%s", 595, topic_len , mTopic3);
        MG_TRACE_Printf((u32)((u32)('U') | ((u32)('S') << 7) | ((u32)('E') << 14) | ((u32)('R') << 21)), "[%d]MQTT topic_len:%d, topic:%s", 596, topic_len , mTopic4);
        app_get_downloadParam(data, date_len);
    }
    else if(strstr(mTopic, mTopic5))
    {
        MG_TRACE_Printf((u32)((u32)('U') | ((u32)('S') << 7) | ((u32)('E') << 14) | ((u32)('R') << 21)), "[%d]MQTT topic_len:%d, topic:%s", 602, topic_len , mTopic5);
        app_get_ParamQF(data, date_len);
        app_pub_paramQF(pApp);
    }
    else if(strstr(mTopic, mTopica))
    {
        MG_TRACE_Printf((u32)((u32)('U') | ((u32)('S') << 7) | ((u32)('E') << 14) | ((u32)('R') << 21)), "[%d]MQTT topic_len:%d, topic:%s", 609, topic_len , mTopica);
