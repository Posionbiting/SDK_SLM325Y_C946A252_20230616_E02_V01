...
#define __CURRENT_FILE_NAME__ app_net
#define __EC618 1
#define CHIP_EC618 1
#define CORE_IS_AP 1
...
static void app_net_status_cb(s32 eventId, ST_NwRegInfo *info, void *param)
{
    ...
    {
    case (0x10000000 + 1):
        MG_TRACE_Printf((u32)((u32)('U') | ((u32)('S') << 7) | ((u32)('E') << 14) | ((u32)('R') << 21)), "EV_OPEN_SIM_CARD_INSERT line[%d]", 16);
        break;
    case (0x10000000 + 2):
        MG_TRACE_Printf((u32)((u32)('U') | ((u32)('S') << 7) | ((u32)('E') << 14) | ((u32)('R') << 21)), "EV_OPEN_SIM_CARD_PULL_OUT line[%d]", 19);
        break;
    case (0x10000000 + 6):
        g_app_cfg.netState = NET_NO_ACT;
        MG_TRACE_Printf((u32)((u32)('U') | ((u32)('S') << 7) | ((u32)('E') << 14) | ((u32)('R') << 21)), "EV_OPEN_PS_DOMAIN_NO_REGISTER line[%d]", 23);
        break;
    case (0x10000000 + 5):
        MG_TRACE_Printf((u32)((u32)('U') | ((u32)('S') << 7) | ((u32)('E') << 14) | ((u32)('R') << 21)), "EV_OPEN_PS_DOMAIN_REGISTER line[%d]", 26);
        break;
    case (0x10000000 + 10):
        MG_TRACE_Printf((u32)((u32)('U') | ((u32)('S') << 7) | ((u32)('E') << 14) | ((u32)('R') << 21)), "EV_OPEN_PDP_MANUAL_DEACTIVATION sim:%d cid:%d line[%d]", pInfo->nSim, pInfo->nCid, 29);
        g_app_cfg.netState = NET_NO_ACT;
        break;
    case (0x10000000 + 9):
        g_app_cfg.netState = NET_ACTED;
        MG_TRACE_Printf((u32)((u32)('U') | ((u32)('S') << 7) | ((u32)('E') << 14) | ((u32)('R') << 21)), "EV_OPEN_PDP_MANUAL_ACTIVATION sim:%d cid:%d line[%d]", pInfo->nSim, pInfo->nCid, 34);
        break;
    case (0x10000000 + 8):
        MG_TRACE_Printf((u32)((u32)('U') | ((u32)('S') << 7) | ((u32)('E') << 14) | ((u32)('R') << 21)), "EV_OPEN_PDP_AUTO_DEACTIVATION sim:%d cid:%d line[%d]", pInfo->nSim, pInfo->nCid, 37);
        g_app_cfg.netState = NET_NO_ACT;
        break;
    case (0x10000000 + 7):
        g_app_cfg.netState = NET_ACTED;
        MG_TRACE_Printf((u32)((u32)('U') | ((u32)('S') << 7) | ((u32)('E') << 14) | ((u32)('R') << 21)), "EV_OPEN_PDP_AUTO_ACTIVATION sim:%d cid:%d line[%d]", pInfo->nSim, pInfo->nCid, 43);
        break;
    default:
        break;
    }
}
static _Bool app_net_doActEx(u8 simId, u8 cid, u32 timeout)
{
    s32 iRet = 0;
    u8 nSignalLevel = 99;
    iRet = MG_NW_GetSignalQuality(simId, &nSignalLevel);
    g_app_cfg.netInfo.signalLevel = nSignalLevel;
    MG_TRACE_Printf((u32)((u32)('U') | ((u32)('S') << 7) | ((u32)('E') << 14) | ((u32)('R') << 21)), "[%d]get csq-> iRet:%d, nSignalLevel:%d", 59, iRet, nSignalLevel);
    if (MG_RET_OK == iRet)
    {
        Enum_NwState nNwState = NW_STATE_NO_REGISTERED;
        iRet = MG_NW_GetNetWorkState(simId, cid, &nNwState);
        MG_TRACE_Printf((u32)((u32)('U') | ((u32)('S') << 7) | ((u32)('E') << 14) | ((u32)('R') << 21)), "[%d]get network state-> iRet:%d, nNwState:%d", 65, iRet, nNwState);
        if (nNwState == NW_STATE_LTE_ACTIVED)
            return 1;
    }
    if (cid != 1)
    {
        iRet = MG_NW_Config(simId, cid, ((void *)0));
        MG_TRACE_Printf((u32)((u32)('U') | ((u32)('S') << 7) | ((u32)('E') << 14) | ((u32)('R') << 21)), "[%d]cid %d set default network cofig-> iRet:%d", 74, cid, iRet);
        if (MG_RET_OK == iRet)
        {
            iRet = MG_NW_Activate(simId, cid, timeout*1000);
            MG_TRACE_Printf((u32)((u32)('U') | ((u32)('S') << 7) | ((u32)('E') << 14) | ((u32)('R') << 21)), "[%d]cid %d do act-> iRet:%d", 79, cid, iRet);
        }
    }
    return iRet != MG_RET_OK ? 0 : 1;
}
void app_net_doAct(int iTimeout, app_cfg_t *pApp)
{
    _Bool isAct = 0;
    ...
    do
    {
        ...
        if (isAct == 1 && pApp->netState == NET_ACTED)
        {
            break;
        }
...
void app_net_task(void)
{
    MG_NW_Register(app_net_status_cb, ((void *)0));
