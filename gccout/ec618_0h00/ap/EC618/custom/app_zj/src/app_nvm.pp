...
#define __CURRENT_FILE_NAME__ app_nvm
#define __EC618 1
#define CHIP_EC618 1
#define CORE_IS_AP 1
...
void app_nvmSaveConfig(void)
{
    ...
    fd = MG_FS_Open("app_config.nvm", 2 | 0x0200 | 0x0400);
    if (fd < 0)
    {
        MG_TRACE_Printf((u32)((u32)('U') | ((u32)('S') << 7) | ((u32)('E') << 14) | ((u32)('R') << 21)), "Can't open/create 'app_config' file, save app_config failed");
        return;
    }
    ...
    {
        MG_TRACE_Printf((u32)((u32)('U') | ((u32)('S') << 7) | ((u32)('E') << 14) | ((u32)('R') << 21)), "Write 'app_config' file header failed");
        MG_FS_Close(fd);
        return;
    }
    ...
    {
        MG_TRACE_Printf((u32)((u32)('U') | ((u32)('S') << 7) | ((u32)('E') << 14) | ((u32)('R') << 21)), "Write 'app_config' file body failed");
    }
    MG_FS_Close(fd);
}
void app_nvmLoadConfig(void)
{
    ...
    s32 rz = 0;
    uint8_t crcCheck = 0;
    fd = MG_FS_Open("app_config.nvm", 0);
    if (fd < 0)
    {
        MG_TRACE_Printf((u32)((u32)('U') | ((u32)('S') << 7) | ((u32)('E') << 14) | ((u32)('R') << 21)), "Can't open 'app_config' file, use the defult value");
    ...
    if (rz <= 0)
    {
        MG_TRACE_Printf((u32)((u32)('U') | ((u32)('S') << 7) | ((u32)('E') << 14) | ((u32)('R') << 21)), "Can't read 'app_config' file header, use the defult value");
        MG_FS_Close(fd);
        app_SetDefaultConfig();
        app_nvmSaveConfig();
        return;
    ...
    || fileHeader.fileBodySize != sizeof(app_nv_config))
    {
        MG_TRACE_Printf((u32)((u32)('U') | ((u32)('S') << 7) | ((u32)('E') << 14) | ((u32)('R') << 21)), "'app_config' version:%d not right, use the defult value", fileHeader.version);
        MG_FS_Close(fd);
        app_SetDefaultConfig();
        app_nvmSaveConfig();
    }
    else
    {
        ...
        {
            MG_TRACE_Printf((u32)((u32)('U') | ((u32)('S') << 7) | ((u32)('E') << 14) | ((u32)('R') << 21)), "Can't read 'app_config' version:%d file body, or body not right, (%u/%u), use the defult value", fileHeader.version, crcCheck, fileHeader.checkSum);
            app_SetDefaultConfig();
            app_nvmSaveConfig();
        }
    }
