...
#define __CURRENT_FILE_NAME__ app_ota
#define __EC618 1
#define CHIP_EC618 1
#define CORE_IS_AP 1
...
static ST_Semaphore *g_ota_semaphore = ((void *)0);
...
static s32 fota_http_stream_input_data(s32 err, s32 statusCode, u8 *data, u32 data_len, void *param, s32 isEnd)
{
    ...
    if (err != MG_RET_OK)
    {
        MG_TRACE_Printf((u32)((u32)('U') | ((u32)('S') << 7) | ((u32)('E') << 14) | ((u32)('R') << 21)), "[%d] fota input data fail err=%d line[%d]", 44, err);
    ...
    if (statusCode != 200)
    {
        MG_TRACE_Printf((u32)((u32)('U') | ((u32)('S') << 7) | ((u32)('E') << 14) | ((u32)('R') << 21)), "[%d] fota input data fail statusCode=%d", 55, statusCode);
        return MG_RET_ERR;
    }
    switch (state)
    {
        case APP_FOTA_STREAM_HTTP_STATE_START:
        {
            ...
            if (iret != MG_RET_OK)
            {
                MG_TRACE_Printf((u32)((u32)('U') | ((u32)('S') << 7) | ((u32)('E') << 14) | ((u32)('R') << 21)), "[%d] fota init fail", 66);
                break;
            }
            iret = MG_FOTA_Start();
            if (iret != MG_RET_OK)
            {
                MG_TRACE_Printf((u32)((u32)('U') | ((u32)('S') << 7) | ((u32)('E') << 14) | ((u32)('R') << 21)), "[%d] fota start fail", 73);
                break;
            }
            totalLen = 0;
        ...
        case APP_FOTA_STREAM_HTTP_STATE_WRITE:
        {
            ...
            while (remainLen > 0)
            {
                ...
                totalLen += nWrSize;
                MG_TRACE_Printf((u32)((u32)('U') | ((u32)('S') << 7) | ((u32)('E') << 14) | ((u32)('R') << 21)), "[%d] fota write, nWrSize %d totalLen %d", 89, nWrSize, totalLen);
                if (nWrSize < 0)
                {
                    iret = nWrSize;
                    break;
    ...
    if (isEnd)
    {
        ...
        iret = MG_FOTA_Update();
        MG_TRACE_Printf((u32)((u32)('U') | ((u32)('S') << 7) | ((u32)('E') << 14) | ((u32)('R') << 21)), "[%d] fota update iret %d", 114, iret);
        _fota_http_stream_state_set(APP_FOTA_STREAM_HTTP_STATE_END);
    }
    return iret;
}
static void _fota_http_stream(u8 cid, const char *url)
{
    ...
    if (((void *)0) == request)
        return;
    MG_HTTP_Register(request, HTTP_REG_TYPE_CONTENT_INPUT_DATA, fota_http_stream_input_data, (void *)((void *)0));
    _fota_http_stream_state_set(APP_FOTA_STREAM_HTTP_STATE_START);
    iResult = MG_HTTP_Get(request, url, ((void *)0), 30*1000);
    if (iResult < 0)
    {
        MG_FOTA_Init();
        MG_TRACE_Printf((u32)((u32)('U') | ((u32)('S') << 7) | ((u32)('E') << 14) | ((u32)('R') << 21)), "[%d] fota update fail", 154);
    }
    else
    {
        MG_TRACE_Printf((u32)((u32)('U') | ((u32)('S') << 7) | ((u32)('E') << 14) | ((u32)('R') << 21)), "[%d] fota update success", 158);
...
static void app_fota_thread(void *param)
{
    ...
    while(1)
    {
        ...
        {
            MG_TRACE_Printf((u32)((u32)('U') | ((u32)('S') << 7) | ((u32)('E') << 14) | ((u32)('R') << 21)), "[%d] fota ing...", 189);
            _fota_http_stream(g_app_cfg.netInfo.cid, (const char *)g_app_cfg.fotaFileDownloadUrl);
            g_app_cfg.isSysUpdate = 0;
        }
    }
    MG_TRACE_Printf((u32)((u32)('U') | ((u32)('S') << 7) | ((u32)('E') << 14) | ((u32)('R') << 21)), "[%d] fota exit thread", 195);
    app_util_threadSleep(1000, g_app_cfg.bLowPowerModeEn);
    MG_OS_ThreadExit();
}
void app_fota_task(void)
{
    MG_OS_ThreadCreate("appfota", app_fota_thread, ((void *)0), Thread_PRIORITY_NORMAL, 1024 * 10, 4);
}
void app_fota_start(void)
{
    if (g_ota_semaphore)
