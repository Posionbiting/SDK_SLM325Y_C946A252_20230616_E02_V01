...
#define __CURRENT_FILE_NAME__ app_util
#define __EC618 1
#define CHIP_EC618 1
#define CORE_IS_AP 1
...
void app_util_jsonDataPack(_Bool bFirst, unsigned int *pOffset, unsigned char attr, const char *tag, const unsigned char *value)
{
    unsigned int mLen;
    union TMP_UBUF mBuff;
    mLen = *pOffset;
    if (bFirst != 1 && attr != ATTR_ARRAY)
    {
