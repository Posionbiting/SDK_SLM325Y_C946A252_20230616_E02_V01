...
#define __CURRENT_FILE_NAME__ mg_openAT_customer
#define __EC618 1
#define CHIP_EC618 1
#define CORE_IS_AP 1
...
#define EV_OPEN_SIM_CARD_INSERT (EV_OPEN_NET_BASE + 1)
#define EV_OPEN_SIM_CARD_PULL_OUT (EV_OPEN_NET_BASE + 2)
#define EV_OPEN_CS_DOMAIN_REGISTER (EV_OPEN_NET_BASE + 3)
#define EV_OPEN_CS_DOMAIN_NO_REGISTER (EV_OPEN_NET_BASE + 4)
#define EV_OPEN_PS_DOMAIN_REGISTER (EV_OPEN_NET_BASE + 5)
#define EV_OPEN_PS_DOMAIN_NO_REGISTER (EV_OPEN_NET_BASE + 6)
#define EV_OPEN_PDP_AUTO_ACTIVATION (EV_OPEN_NET_BASE + 7)
#define EV_OPEN_PDP_AUTO_DEACTIVATION (EV_OPEN_NET_BASE + 8)
#define EV_OPEN_PDP_MANUAL_ACTIVATION (EV_OPEN_NET_BASE + 9)
#define EV_OPEN_PDP_MANUAL_DEACTIVATION (EV_OPEN_NET_BASE + 10)
#define EV_OPEN_NET_END 0x100000FF
#define EV_OPEN_SMS_BASE 0x10000100
#define EV_OPEN_SMS_NEW (EV_OPEN_SMS_BASE + 1)
...
#define MODULE_SN1 0
#define MODULE_SN2 1
#define SYS_BOOTCAUSE_BIT0_UNKNOWN (1 << 0)
#define SYS_BOOTCAUSE_BIT1_PWRKEY (1 << 1)
#define SYS_BOOTCAUSE_BIT2_PIN_RESET (1 << 2)
#define SYS_BOOTCAUSE_BIT3_ALARM (1 << 3)
#define SYS_BOOTCAUSE_BIT4_CHARGE (1 << 4)
#define SYS_BOOTCAUSE_BIT5_WDG (1 << 5)
#define SYS_BOOTCAUSE_BIT6_PIN_WAKEUP (1 << 6)
#define SYS_BOOTCAUSE_BIT7_PSM_WAKEUP (1 << 7)
#define SYS_BOOTCAUSE_BIT8_PANIC (1 << 8)
#define SYS_BOOTCAUSE_BIT9_FORCE (1 << 9)
...
typedef enum
{
    MG_ADC_CHANNEL_THERMAL = 0U,
    MG_ADC_CHANNEL_VBAT = 1U,
    MG_ADC_CHANNEL_AIO4 = 2U,
    MG_ADC_CHANNEL_AIO3 = 3U,
    MG_ADC_CHANNEL_AIO2 = 4U,
    MG_ADC_CHANNEL_AIO1 = 5U,
} Enum_AdcChannel;
...
typedef struct APP_CFG_T
{
    u8 netState;
    u8 workState;
    _Bool bLowPowerModeEn;
    app_dev_info_t devInfo;
    app_battery_info_t batteryInfo;
    app_net_info_t netInfo;
    app_gnss_data_t gnssData;
    app_mqtt_cfg_t mqtt;
    app_nv_config nvConfig;
    _Bool isSysUpdate;
    u8 fotaFileDownloadUrl[256];
} app_cfg_t;
extern char g_app_tmpBuff[1024*10];
extern app_cfg_t g_app_cfg;
#define _APP_ERR_H 
...
void app_util_jsonDataPack(_Bool bFirst,
                                   unsigned int *pOffset,
                                   unsigned char attr,
                                   const char *tag,
                                   const unsigned char *value);
void app_util_threadSleep(s32 ms, _Bool bLowPowerEn);
_Bool app_util_eventWait(ST_Thread *thread, ST_Event *event, s32 ms, _Bool bLowPowerEn);
_Bool app_util_eventSend(ST_Thread *thread, ST_Event *event, s32 ms, _Bool bLowPowerEn);
