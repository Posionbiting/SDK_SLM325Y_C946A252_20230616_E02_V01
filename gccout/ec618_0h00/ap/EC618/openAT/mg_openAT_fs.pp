...
#define __CURRENT_FILE_NAME__ mg_openAT_fs
#define __EC618 1
#define CHIP_EC618 1
#define CORE_IS_AP 1
...
#define MID_WARE_DM_LOCATION_LEN 15
...
#define MID_WARE_DM_SIM_CCID_LEN 24
#define MID_WARE_DM_SIM_IMSI_LEN 18
#define MID_WARE_DM_IMEI_LEN 18
#define MID_WARE_DM_MODEL_LEN 24
#define MID_WARE_DM_SWVER_LEN 64
#define MID_WARE_DM_HWVER_LEN 64
#define MID_WARE_DM_PRODUCT_KEY_LEN (20)
#define MID_WARE_DM_PRODUCT_SECRET_LEN (36)
#define MID_WARE_DM_DEVICE_KEY_LEN (36)
#define MID_WARE_DM_DEVICE_SECRET_LEN (100)
#define MID_WARE_DM_MANUFACTURE_LEN (16)
#define MID_WARE_DM_MODULE_TYPE_LEN (24)
#define MID_WARE_DM_MODULE_SW_LEN (32)
#define MID_WARE_DM_MODULE_HW_LEN (32)
#define MID_WARE_SMS_SCA_LEN 40
#define MID_WARE_SMS_VP_MAX_LEN 7
#define MID_WARE_CSCS_MAX_LEN 10
#define MID_WARE_CTW_SOFTVERSION_LEN 24
#define MID_WARE_CTW_MODULE_LEN 24
#define MID_WARE_CTW_CHIPTYPR_LEN 24
#define MID_WARE_CTW_MASTERKEY_LEN 32
#define MID_WARE_CTW_DEVICEID_LEN 72
#define MID_WARE_CTW_PASSWD_LEN 43
#define MID_WARE_CTW_MQTT_URI_LEN 128
#define MID_WARE_CTW_MQTT_CLIENT_ID_LEN 64
#define MID_WARE_CTW_MQTT_USER_NAME_LEN 72
#define MID_WARE_CTW_MQTT_PASSWD_LEN 72
typedef enum MidWareATChanCfgEnum_Tag
{
    MID_WARE_AT_CHAN_ECHO_CFG,
    MID_WARE_AT_CHAN_SUPPRESS_CFG,
    MID_WARE_AT_CHAN_CREG_RPT_CFG,
    MID_WARE_AT_CHAN_CEREG_RPT_CFG,
    MID_WARE_AT_CHAN_EDRX_RPT_CFG,
    MID_WARE_AT_CHAN_CIOT_OPT_RPT_CFG,
    MID_WARE_AT_CHAN_CSCON_RPT_CFG,
    MID_WARE_AT_CHAN_SMS_MODE_CFG,
    MID_WARE_AT_CHAN_TIME_ZONE_REP_CFG,
    MID_WARE_AT_CHAN_TIME_ZONE_UPD_CFG,
    MID_WARE_AT_CHAN_CMEE_CFG,
    MID_WARE_AT_CHAN_ECCESQ_RPT_CFG,
    MID_WARE_AT_CHAN_CGEREP_MODE_CFG,
    MID_WARE_AT_CHAN_PSM_RPT_CFG,
    MID_WARE_AT_CHAN_EMM_TIME_RPT_CFG,
    MID_WARE_AT_CHAN_PTW_EDRX_RPT_CFG,
    MID_WARE_AT_CHAN_ECPIN_STATE_RPT_CFG,
    MID_WARE_AT_CHAN_ECPADDR_RPT_CFG,
    MID_WARE_AT_CHAN_ECPCFUN_RPT_CFG,
    MID_WARE_AT_CHAN_ECLED_MODE_CFG,
    MID_WARE_AT_CHAN_ECPURC_HIB_RPT_CFG,
    MID_WARE_AT_CHAN_SMS_SERVICE_CFG,
    MID_WARE_AT_CHAN_SMS_TEXT_SHOW_CFG,
    MID_WARE_AT_CHAN_ECPURC_SLP2_RPT_CFG,
    MID_WARE_AT_CHAN_ECPURC_SLP1_RPT_CFG,
    MID_WARE_AT_CHAN_SMS_MEM_CAP_CFG,
    MID_WARE_AT_CHAN_DCD_MODE_CFG,
    MID_WARE_AT_CHAN_DTR_MODE_CFG,
    MID_WARE_AT_CHAN_CFG_MAX
}MidWareATChanCfgEnum;
typedef struct MWCfgAtChanConfig_Tag
{
    UINT32 chanId : 4;
    UINT32 echoValue : 1;
    UINT32 suppressionValue : 1;
    UINT32 cregRptMode : 2;
    UINT32 ceregRptMode : 3;
    UINT32 needEdrxRpt : 1;
    UINT32 needCiotOptRpt : 3;
    UINT32 smsSendMode : 1;
    UINT32 csconRptMode : 2;
    UINT32 cmeeMode : 2;
    UINT32 timeZoneRptMode : 2;
    UINT32 timeZoneUpdMode : 1;
    UINT32 cgerepMode : 1;
    UINT32 eccesqRptMode : 2;
    UINT32 ecpsmRptMode : 1;
    UINT32 ecemmtimeRptMode : 3;
    UINT32 ecPtwEdrxRpt : 1;
    UINT32 ecpinRptMode : 1;
    UINT32 ecpaddrRptMode : 1;
    UINT32 ecpcfunRptMode : 1;
    UINT32 ecledMode : 1;
    UINT32 ecHibRptMode : 1;
    UINT32 smsService : 1;
    UINT32 smsShowMode : 1;
    UINT32 ecSlp2RptMode : 1;
    UINT32 ecSlp1RptMode : 1;
    UINT32 smsMemCapExceed : 1;
    UINT32 dcdMode : 1;
    UINT32 dtrMode : 2;
    UINT32 rsvd0 : 20;
}MWCfgAtChanConfig;
...
typedef enum MidWareCfgParamId_Enum
{
    MW_CFG_PARAM_BASE = 1024,
    MW_CFG_AT_CHAN_1_CONFIG,
    MW_CFG_AT_CHAN_2_CONFIG,
    MW_CFG_AT_CHAN_3_CONFIG,
    MW_CFG_AT_CHAN_4_CONFIG,
    MW_CFG_CSCS_PARAM,
    MW_CFG_SMS_TEXT_CSMP_PARAM,
    MW_CFG_SMS_MEM_CPMS_PARAM,
    MW_CFG_SMS_SCA_CSCA_PARAM,
    MW_CFG_SMS_URC_CNMI_PARAM,
    MW_CFG_POWER_ON_CFUN,
    MW_CFG_DEFAULT_DNS,
    MW_CFG_AT_SOCKET_PARAM,
    MW_CFG_DM_CTCC_PARAM,
    MW_CFG_DM_CMCC_PARAM,
    MW_CFG_DM_CUCC_PARAM,
    MW_CFG_ALARM_PARAM,
    MW_CFG_NET_PARAM,
    MW_CFG_URCCACHE_PARAM,
    MW_CFG_CTW_CFG_PARAM,
    MW_CFG_CTW_HTTP_PARAM,
    MW_CFG_CTW_MQTT_PARAM,
    MW_CFG_CTW_TCP_PARAM,
    MW_CFG_AT_PEND_URC_PARAM,
    MW_CFG_URC_DELAY_PARAM,
    MW_CFG_URC_RI_SMS_INCOMING_PARAM,
    MW_CFG_URC_RI_OTHER_PARAM,
    MW_CFG_PPP_AUTH_SELECT_PARAM,
    MW_CFG_MG_SYS_PARAM,
    MW_CFG_MG_URC_DELAY_PARAM,
    MW_CFG_PARAM_END,
    MW_CFG_PARAM_MAX = MW_CFG_PARAM_BASE + 0x100
}MidWareCfgParamId;
typedef MWCfgAtChanConfig MWNvmCfgAtChanConfig;
typedef struct MWNvmCfgCSCSParam_Tag
{
    CHAR characterSet[10];
}MWNvmCfgCSCSParam;
typedef struct MWNvmCfgCSMPParam_Tag
{
    UINT8 fo;
    UINT8 pid;
    UINT8 dcs;
...
typedef struct MWNvmCfgCPMSParam_Tag
{
    UINT8 mem1;
    UINT8 mem2;
    UINT8 mem3;
...
typedef struct MWNvmCfgCSCAParam_Tag
{
    UINT8 scaPresent;
    UINT8 typeOfNumber;
    UINT8 numberPlanId;
    UINT8 digitlen;
    UINT8 addressDigits[40];
}MWNvmCfgCSCAParam;
typedef struct MWNvmCfgCNMIParam_Tag
{
    UINT8 mode;
    UINT8 mt;
    UINT8 bm;
...
typedef struct MWNvmCfgDefaultDns_Tag
{
    UINT8 ipv4Dns[2][4];
    UINT8 ipv6Dns[2][16];
}MWNvmCfgDefaultDns;
typedef struct MWNvmCfgNetParam_Tag
{
    BOOL bAutoDial;
    UINT8 cid;
    BOOL bNetDevCtlUrc;
    BOOL bNatEnable;
    UINT8 localHostAddr[4];
}MWNvmCfgNetParam;
typedef struct MWNvmCfgAtSocketParam_Tag
{
    UINT8 mode;
    UINT8 publicDlPkgNumMax;
    UINT16 publicDlBufferToalSize;
}MWNvmCfgAtSocketParam;
typedef struct MWNvmCfgPowerOnCfun_Tag
{
    UINT8 cfun;
    UINT8 rsvd;
    UINT16 maxDelayS;
}MWNvmCfgPowerOnCfun;
typedef struct MWNvmCfgDmCuccParam_Tag
{
    UINT8 enableFlag;
    UINT8 hasReg;
    UINT8 imsi[18];
    UINT8 ccid[24];
    UINT8 imei[18];
    UINT8 manufacture[(16)];
    UINT8 moduleType[(24)];
    UINT8 moduleSWVer[(32)];
    UINT8 moduleHWVer[(32)];
    UINT8 productKey[(20)];
    UINT8 productSecret[(36)];
    UINT8 deviceKey[(36)];
}MWNvmCfgDmCuccParam;
typedef struct MWNvmCfgDmCtccParam_Tag
{
    UINT8 enableFlag;
    UINT8 hasReg;
    UINT8 ccid[24];
...
typedef struct MWNvmCfgDmCmccParam_Tag
{
    UINT8 enableFlag;
    UINT8 bConnected;
    UINT8 platform;
...
typedef struct MWNvmCfgAlarmParam_Tag
{
...
typedef struct MWNvmCfgCtwParamCfg_Tag
{
    CHAR softVersion[24 +1];
    CHAR module[24 +1];
    CHAR chipType[24 +1];
}MWNvmCfgCtwParamCfg;
typedef struct MWNvmCfgCtwHttpParam_Tag
{
    UINT8 enableFlag;
    CHAR masterKey[32 +1];
    CHAR deviceId[72 +1];
...
typedef struct MWNvmCfgCtwTcpParam_Tag
{
    UINT8 enableFlag;
    CHAR deviceId[72 +1];
    CHAR password[43 +1];
}MWNvmCfgCtwTcpParam;
typedef struct MWNvmCfgCtwMqttParam_Tag
{
    UINT8 autoRegEnableFlag;
    UINT8 mqttsFlag;
    UINT8 autoRegStatus;
    CHAR uri[128 +1];
    UINT32 port;
...
typedef struct MWNvmCfgAtPendUrcParam_Tag
{
    UINT8 atPendUrcEnableFlag[4];
}MWNvmCfgAtPendUrcParam;
typedef struct MWNvmCfgUrcDelayParam_Tag
{
    UINT16 urcDelayMs[4];
}MWNvmCfgUrcDelayParam;
typedef struct MGNvmCfgUrcDelayParam_Tag
{
    UINT32 urcDelayMs[4];
}MGNvmCfgUrcDelayParam;
typedef struct MWNvmCfgUrcRISmsIncomingParam_Tag
{
    UINT8 type;
    UINT8 pulseCount;
    UINT16 pulseDuration;
}MWNvmCfgUrcRISmsIncomingParam;
typedef struct MWNvmCfgUrcRIOtherParam_Tag
{
    UINT8 type;
    UINT8 pulseCount;
    UINT16 pulseDuration;
}MWNvmCfgUrcRIOtherParam;
typedef struct MidWareNvmConfig_Tag
{
    MWNvmCfgAtChanConfig atChanConfig[4];
    UINT8 pppAuthSelectMode;
    UINT8 resv0[3];
    MWNvmCfgCSCSParam characterCscsCfg;
    MWNvmCfgCSMPParam smsTextCfgCSMP;
    MWNvmCfgCPMSParam smsMemCfgCPMS;
    MWNvmCfgCSCAParam smsScaCfgCSCA;
    MWNvmCfgCNMIParam smsUrcCfgCNMI;
    MWNvmCfgDefaultDns defaultDnsCfg;
    MWNvmCfgAtSocketParam ecSocketCfg;
    MWNvmCfgPowerOnCfun powerCfun;
    MWNvmCfgDmCuccParam dmCuccParam;
    MWNvmCfgDmCtccParam dmCtccParam;
    MWNvmCfgDmCmccParam dmCmccParam;
    MWNvmCfgAlarmParam almParam;
    MWNvmCfgCtwParamCfg ctwParamCfg;
    MWNvmCfgCtwHttpParam ctwHttpParam;
    MWNvmCfgCtwTcpParam ctwTcpParam;
    MWNvmCfgCtwMqttParam ctwMqttParam;
    MWNvmCfgNetParam netParamCfg;
    MWNvmCfgAtPendUrcParam atPendUrcParamCfg;
    MWNvmCfgUrcDelayParam urcDelayParamCfg;
    MWNvmCfgUrcRISmsIncomingParam urcRISmsIncomingParamCfg[4];
    MWNvmCfgUrcRIOtherParam urcRIOtherParamCfg[4];
    MGNvmConfig mgSySParam;
    MGNvmCfgUrcDelayParam mgUrcDelayParamCfg;
}MidWareNvmConfig;
...
void mwNvmCfgSetAndSaveUrcDelayParam(UINT8 chanId, UINT32 urcDelayMs);
UINT32 mwNvmCfgGetUrcDelayParam(UINT8 chanId);
...
typedef struct MidWareNvmInfo_Tag
{
    UINT8 phyDebugAtCont[64];
}MidWareNvmInfo;
...
#define ECPS_TRACE(moduleId,subId,debugLevel,argLen,format,...) do { swLogPrintf(UNILOG_PS1 ##__ ##moduleId ##__ ##subId, debugLevel, ##__VA_ARGS__); {(void)format;} }while(0)
#define ECPS_PRINTF(moduleId,subId,debugLevel,format,...) do { swLogPrintf(UNILOG_PS1 ##__ ##moduleId ##__ ##subId, debugLevel, ##__VA_ARGS__); {(void)format;} }while(0)
#define ECPS_DUMP(moduleId,subId,debugLevel,format,dumpLen,dump) do { swLogDump(UNILOG_PS1 ##__ ##moduleId ##__ ##subId, debugLevel, dumpLen, dump); {(void)format;} }while(0)
#define ECPS_DUMP_POLLING(moduleId,subId,debugLevel,format,dumpLen,dump) do { swLogDumpPolling(UNILOG_PS1 ##__ ##moduleId ##__ ##subId, debugLevel, dumpLen, dump); {(void)format;} }while(0)
#undef PS_ENABLE_LPP_LCS_FEATURE
#define GOS_GET_SIGNAL_FROM_BODY OSA_GET_SIGNAL_FROM_BODY
#define ALIGNED_4BYTE __ALIGNED(4)
#define ALIGNED_128KB CAT_UP_DATA
#define PS_CODE_IN_RAM PS_FM_RAMCODE
#define PS_SLP2_ZI PS_FA_ZI
#define PS_SLP2_DATA PS_FA_DATA
...
void GosFreeMemoryFromPhy(void **ptr);
#define GosAllocMemory OsaAllocMemory
#define GosAllocZeroMemory OsaAllocZeroMemory
#define GosAllocMemoryNoAssert OsaAllocMemoryNoAssert
#define GosAllocZeroMemoryNoAssert OsaAllocZeroMemoryNoAssert
...
#define PsFreeSlp2Mem(pPtr) do { GosCheck((pPtr) != PNULL && (*(pPtr)) != PNULL, (pPtr), (*(pPtr)), 0); PsSlp2FreeEC(*(pPtr)); (*(pPtr)) = PNULL; }while(FALSE);
...
#define GosMsgEnQueue(Q,M,H,S) do { GosLogInternalMsg((M), #H, (S)); UnitEnQueue((Q), (M)); }while(FALSE)
...
#define CMS_SOCK_MGR_RESPONSE_LEN_MAX 256
#define CMS_SOCK_MGR_CONNECT_TIMEOUT 31
...
#define CMS_SOCK_TOTAL_MGR_DL_LENGTH_MAX (12*1024)
#define CMS_SOCK_MGR_SELECT_WAIT_TIME (2)
...
typedef enum {
    CME_REF_SOCK_SUCC = 0,
    CME_REF_SOCK_UNKNOWN_ERROR = 550,
    CME_REF_SOCK_OPERATION_BLOCKED = 551,
    CME_REF_SOCK_INVALID_PARAM = 552,
    CME_REF_SOCK_MEM_NOT_ENOUGH = 553,
    CME_REF_SOCK_SOCK_CREATE_FAIL = 554,
    CME_REF_SOCK_OPERATION_NOT_SUPPORT = 555,
    CME_REF_SOCK_SOCK_BIND_FAIL = 556,
    CME_REF_SOCK_SOCK_LISTEN_FAIL = 557,
    CME_REF_SOCK_SOCK_WRITE_FAIL = 558,
    CME_REF_SOCK_SOCK_READ_FAIL = 559,
    CME_REF_SOCK_ACCEPT_FAIL = 560,
    CME_REF_SOCK_PDP_CTX_OPEN_FAIL = 561,
    CME_REF_SOCK_PDP_CTX_CLOSE_FAIL = 562,
    CME_REF_SOCK_SOCK_ID_HAS_BEEN_USED = 563,
    CME_REF_SOCK_DNS_BUSY = 564,
    CME_REF_SOCK_DNS_PARSE_FAIL = 565,
    CME_REF_SOCK_SOCK_CONNECT_FAIL = 566,
    CME_REF_SOCK_SOCK_HAS_BEEN_CLOSE = 567,
    CME_REF_SOCK_OPERATION_BUSY = 568,
    CME_REF_SOCK_OPERATION_TIMEOUT = 569,
    CME_REF_SOCK_PDP_CTX_BROKEN_DOWN = 570,
    CME_REF_SOCK_CANCEL_SENDING = 571,
    CME_REF_SOCK_OPERATION_NOT_ALLOWED = 572,
    CME_REF_SOCK_APN_NOT_CONFIGURED = 573,
    CME_REF_SOCK_PORT_BUSY = 574,
    CME_REF_SOCK_SOCK_OPTION_SET_FAIL = 575,
    CME_REF_SOCK_BUFFSIZE_NOT_ENOUGH = 800,
    CME_REF_SOCK_MGR_ERROR_PARAM_ERROR = 801,
    CME_REF_SOCK_MGR_WRITE_IS_ONGOING = 802,
...
typedef struct CmsSockMgrConnHibContext_Tag{
    ...
    void *eventCallback;
    UINT8 priContext[32];
}CmsSockMgrConnHibContext;
typedef struct CmsSockMgrHibContext_Tag{
    UINT16 magic;
    UINT16 flag;
    CmsSockMgrConnHibContext tcpContext;
    CmsSockMgrConnHibContext udpContext;
}CmsSockMgrHibContext;
...
BOOL cmsSockMgrRemoveUlPendingNode(CmsSockMgrContext *pSockMgrContext,CmsSockUlPendingList *pRemoveList);
INT32 cmsSockMgrRemvUlAllPendingList(CmsSockMgrContext *pSockMgrContext);
INT32 cmsSockMgrProcUlPendingList(void);
UINT32 cmsSockMgrQueryDlfcUsedSize(void);
...
{
    UINT32 psTaskCreated : 1;
    UINT32 psTaskReady : 1;
    UINT32 psNeedWakeup : 1;
    UINT32 bActIfDuringWakeup : 1;
    UINT32 bSilentReset : 1;
    UINT32 rsvd0 : 3;
    UINT32 actingCid : 8;
    UINT32 actingCidCgevReason: 4;
    UINT32 psConnStatus : 1;
    UINT32 bTrafficIdleTriggerTau:1;
    UINT32 rsvd1 : 10;
    CmiSimImsiStr ueImsi;
}PsDialContext;
typedef struct PsDialAonInfo_Tag
{
    UINT32 cfunState : 8;
    UINT32 ceregState : 4;
    UINT32 psTaskCreatedBefore : 1;
    UINT32 bSmsReady : 1;
    UINT32 rsvd0 : 2;
    UINT32 rsvd1 : 16;
}PsDialAonInfo;
typedef struct PsDialDnsCfg_Tag
{
    ...
    UINT8 ipv6DnsNum ;
    UINT16 rsvd;
    ip4_addr_t ipv4Dns[2];
    ip6_addr_t ipv6Dns[2];
}PsDialDnsCfg;
typedef enum {
...
{
    MW_AON_NET_DEV_CTL_OP_BIND_CID_CANCEL = 0,
    MW_AON_NET_DEV_CTL_OP_BIND_CID_ONCE = 1,
    MW_AON_NET_DEV_CTL_OP_BIND_CID_REPEAT = 2,
    MW_AON_NET_DEV_CTL_OP_BIND_CID_AUTO = 3,
    MW_AON_NET_DEV_CTL_OP_BIND_CID_UNKNOWN = 15
}MWAonNetDevCtlOp;
...
typedef struct MidWareDefaultAonDnsCfg_Tag
{
    ...
    ip4_addr_t ipv4Dns[2];
    ip6_addr_t ipv6Dns[2];
}MidWareDefaultAonDnsCfg;
typedef MWCfgAtChanConfig MWAonAtChanConfig;
typedef struct MWAonNetParamCfg_Tag
{
    UINT32 netDevCtlOp :4;
    UINT32 bNetDevCtlUrc :1;
    UINT32 bNatEnable :1;
    UINT32 bBindStateSucc :1;
    UINT32 bBindStateReported :1;
    UINT32 cid :8;
    UINT32 resvd2 :16;
    UINT8 localHostAddr[4];
}MWAonNetParamCfg;
...
{
    MW_AON_PPP_LINK_STATE_NO_CARRIER = 0,
    MW_AON_PPP_LINK_STATE_CONNECTING = 1,
    MW_AON_PPP_LINK_STATE_CONNECTED = 2,
}MWAonPppLinkState;
...
extern SignalQueue gCmsPendingSigQueue;
...
#define AT_IGNORE_SPACE_CHAR(pChr,pEnd) do { while (((*(pChr)) == ' ') && ((UINT32)(pChr) < (UINT32)(pEnd))) (pChr)++; }while(FALSE)
#define AT_IGNORE_SPACE_S3_S4_CHAR(pChr,S3,S4,pEnd) do { while (((*(pChr)) == ' ' || (*(pChr)) == (S3) || (*(pChr)) == (S4)) && ((UINT32)(pChr) < (UINT32)(pEnd))) (pChr)++; }while(FALSE)
#define ATC_CHAN_REAL_ENTITY_NUM (CMS_CHAN_NUM-1)
#define AT_DEFAULT_TIMEOUT_SEC ((UINT16)5)
#define AT_CMD_PARAM_MAX_NUM 32
#define AT_CMD_MAX_NAME_LEN 32
#define AT_CMD_MAX_PENDING_STR_LEN 8192
#define AT_CMD_MAX_PENDING_NODE_NUM 64
...
#define AT_SEPA_PARM_COMMA_CHAR ','
...
#define AT_BE_VALID_CHAR(chr) ((chr) >= 0x20 || (chr) == '\r' || (chr) == '\n')
#define AT_BE_EXT_CMD_CHAR(cr) ((cr) == AT_EXT_CMD_PLUS_CHAR || (cr) == AT_EXT_CMD_STAR_CHAR || (cr) == AT_EXT_CMD_CARET_CHAR)
#define AT_S3_CMD_LINE_TERM_CHAR_IDX (0)
#define AT_S4_RESP_FORMAT_CHAR_IDX (1)
#define AT_S5_CMD_LINE_EDIT_CHAR_IDX (2)
...
#define AT_HANDSHAKE_REQ_STR_LEN 6
#define AT_HANDSHAKE_RESP_STR_LEN 6
...
typedef enum
{
    AT_URC_RI_NONE,
    AT_URC_RI_TIGGER,
    AT_RI_DONE_URC_DELAY,
    AT_URC_RI_DONE
}AtUrcRiState;
typedef enum
{
    AT_DATA_STATE_DATA_INPUT,
    AT_DATA_STATE_DTR_EVT,
    AT_ONLINE_CMD_ATO_EVT,
...
typedef struct AtChanMiscellaneous_Tag
{
    UINT32 endSetbaud : 1;
    UINT32 endReset : 1;
    UINT32 endPowerOff : 1;
    UINT32 rsvd : 20;
    UINT32 baudSaveFlag: 1;
    UINT32 poweroffMode : 8;
    UINT32 baudrate;
    UINT32 baudFrameFormat;
    UINT32 resetDelayMs;
}AtChanMiscellaneous;
...
typedef struct AtChanEntity_tag
{
    ...
    UINT32 nextTid : 5;
    UINT32 curTid : 5;
    UINT32 bWaitDataModeHSCnf : 1;
    UINT32 rsvd1 : 21;
    CHAR chanName[8];
    AtChanConfig cfg;
    AtInputInfo atInputInfo;
    AtCmdLineInfo atLineInfo;
    AtChanUrcInfo urcInfo;
    struct
    {
        AtRespFunctionP respFunc;
        void *pArg;
        osSemaphoreId_t apiSem;
        CHAR *pBufResp;
        UINT16 respBufLen;
    ...
    UINT16 preDefMeigCmdNum;
    AtCmdPreDefInfoC *pPreDefMeigCmdList;
    UINT16 preDefopenCmdNum;
    AtCmdPreDefInfoC *pPreDefopenCmdList;
...
#define PDP_CID_2 2
#define PDP_CID_3 3
#define PDP_CID_MIN PDP_CID_1
#define PDP_CID_MAX PDP_CID_3
...
#define MCI_TRACE_PrintfEX(level,tag,fmt,...) do { if (MCI_TRACE_LOG_LEVEL >= level) { ECPLAT_PRINTF(UNILOG_MCI, tag, P_INFO, fmt, ##__VA_ARGS__); } } while (0)
...
_Bool MG_OS_MutexLock(ST_Mutex *mutex, s32 timeout);
_Bool MG_OS_MutexLockLowPower(ST_Mutex *mutex);
...
_Bool MG_OS_SemaphoreAcquire(ST_Semaphore *sem, s32 timeout);
_Bool MG_OS_SemaphoreAcquireLowPower(ST_Semaphore *sem);
void MG_OS_SemaphoreDelete(ST_Semaphore *sem);
_Bool MG_OS_EventWait(ST_Thread *thread, ST_Event *event, s32 timeout);
_Bool MG_OS_EventWaitLowPower(ST_Thread *thread, ST_Event *event);
_Bool MG_OS_EventSend(ST_Thread *thread, ST_Event *event, s32 timeout);
_Bool MG_OS_EventSendLowPower(ST_Thread *thread, ST_Event *event);
...
#define OPENAT_LIST_STRUCT_MEMBERS s32 is_header; char name[OPEN_AT_FS_FILE_NAME_MAX_LEN +1 ]; struct _fileInfo *next;
typedef struct _fileInfo
{
    s32 is_header; char name[64 +1 ]; struct _fileInfo *next;
} openAt_fileInfo;
openAt_fileInfo *openFileInfoList = ((void *)0);
static openAt_fileInfo * _open_at_list_new()
{
    ...
    MG_TRACE_PrintfEX(MG_TRACE_LOG_LEVEL_DEBUG, (u32)((u32)('A') | ((u32)('T') << 7) | ((u32)('F') << 14) | ((u32)('S') << 21)), " headerlist : %x", list);
    return list;
}
static openAt_fileInfo *_open_at_node_new(char *fileName)
{
    openAt_fileInfo *node = ((void *)0);
    u32 len = 0;
...
{
    openAt_fileInfo *node = ((void *)0);
    openAt_fileInfo *pCurNode = ((void *)0);
    if (list == ((void *)0) || fileName == ((void *)0))
    {
        return ((void *)0);
    }
    ...
    do
    {
        ...
        {
            MG_TRACE_PrintfEX(MG_TRACE_LOG_LEVEL_DEBUG, (u32)((u32)('A') | ((u32)('T') << 7) | ((u32)('F') << 14) | ((u32)('S') << 21)), "list :%x, pCurNode : %x,  headFlag:%d", list, pCurNode, pCurNode->is_header);
...
static BOOL _open_at_is_header(openAt_fileInfo *list)
{
    ...
    return (list->is_header == 1) ? (((BOOL)1)) : (((BOOL)0));
}
...
{
    openAt_fileInfo *newNode = ((void *)0);
    u32 nCritical = 0;
    if ((((void *)0) == list) || name == ((void *)0))
        return -1;
...
{
    openAt_fileInfo *pPreNode = ((void *)0);
    openAt_fileInfo *pCurNode = ((void *)0);
    u32 nCritical = 0;
    u32 isFound = 0;
    if (list == ((void *)0) || fileName == ((void *)0))
...
static s32 _dwnfile(const char *file_name, const void *data, u32 size)
{
    s32 fd = -1;
    s32 wlen = -1;
    if (file_name == ((void *)0) || data == ((void *)0) || size == 0)
        return -1;
    fd = MG_FS_Open(file_name, 2 | 0x0200 | 0x0400);
    if (fd >= 0)
    {
...
static s32 _dwnfilePushData(void *ctx, u8 chanId, const void *data, u32 size)
{
    ...
    do
    {
        if (async == ((void *)0) || data == ((void *)0) || size == 0)
            break;
        ...
        if (async->pos >= async->size)
        {
            ...
            {
                mg_openAT_SetLineMode(chanId);
                mg_openAT_cmdRespError(async->atHandle, 701);
            }
            isEof = 1;
        }
        else if(pMem[async->pos-1] == 0x1A)
        {
...
CmsRetId openFSDWNFILE(const AtCmdInputContext *pAtCmdReq)
{
    ...
    UINT32 atHandle = ((UINT16)(((pAtCmdReq->tid)&0x1F) | (((7)<<5)&0xE0) | (((pAtCmdReq->chanId)<<8)&0xF00)));
    UINT32 operaType = (UINT32)pAtCmdReq->operaType;
    UINT8 chanId = (UINT8)(((atHandle) & 0xF00) >> 8);
    CHAR rspBuf[128] = {0};
    BOOL paramok = ((BOOL)1);
    switch (operaType)
    {
        case AT_TEST_REQ:
        {
            MG_UTILS_Snprintf((u8 *)rspBuf, 128, "+FSDWNFILE: filename,size");
        ...
        case AT_SET_REQ:
        {
            ...
            {
                rc = mg_openAT_cmdRespError(atHandle, 702);
                break;
            }
            fileName = (char *)MG_MEM_Calloc(1, 64 + 1 );
            if (fileName == ((void *)0))
            {
                rc = mg_openAT_cmdRespError(atHandle, 703);
                break;
            }
            fileNameLen = mg_openAT_cmdParamStr(pAtCmdReq->pParamList, 0, (u8 *)fileName, 64, &paramok);
            length = mg_openAT_cmdParamUintInRange(pAtCmdReq->pParamList, 1, 0, 20*1024, 0, &paramok);
            if( ( !paramok ) || ( fileNameLen <= 0 ) ||
                ( MG_UTILS_Strlen( (char *)fileName ) > 64 ) ||
                ( length <= 0 ) )
            {
        ...
        default:
        {
            rc = mg_openAT_cmdRespError(atHandle, 704);
            break;
        }
    }
    return rc;
...
CmsRetId openFSRDFILE(const AtCmdInputContext *pAtCmdReq)
{
    ...
    switch (operaType)
    {
        case AT_TEST_REQ:
        {
            MG_UTILS_Snprintf((u8 *)rspBuf, 128, "+FSRDFILE: filename");
            rc = mg_openAT_cmdRespTextAndOK(atHandle, rspBuf);
            break;
        }
        case AT_SET_REQ:
        {
            ...
            char *pBuffer = ((void *)0);
            char *pRspBuffer = ((void *)0);
            s32 fd = -1;
            s32 pos = 0;
            s32 len = 0;
            s32 rz = 0;
            s32 nRspBufSize = 0;
            fileNameLen = mg_openAT_cmdParamStr(pAtCmdReq->pParamList, 0, (UINT8 *)fileName, 64, &paramok);
            if(!paramok || fileNameLen <= 0)
            {
                rc = mg_openAT_cmdRespError(atHandle, 702);
                break;
            ...
            if (file_size > 20*1024 || file_size <= 0)
            {
                rc = mg_openAT_cmdRespError(atHandle, 701);
                break;
            }
            pBuffer = MG_MEM_Calloc(1, 1024 +1);
            if (pBuffer == ((void *)0))
            {
                rc = mg_openAT_cmdRespError(atHandle, 702);
                break;
            ...
            if (pRspBuffer == ((void *)0))
            {
                MG_MEM_Free(pBuffer);
                rc = mg_openAT_cmdRespError(atHandle, 702);
                break;
            }
            fd = MG_FS_Open((char *)fileName, 0);
            if (fd < 0)
            {
                MG_MEM_Free(pBuffer);
            ...
            while (pos < file_size)
            {
                MG_UTILS_Memset(pBuffer, 0, 1024 +1);
...
CmsRetId openFSDELFILE(const AtCmdInputContext *pAtCmdReq)
{
    ...
    switch (operaType)
    {
        case AT_TEST_REQ:
        {
            MG_UTILS_Snprintf((u8 *)rspBuf, 128, "+FSDELFILE: filename[,tag]");
            rc = mg_openAT_cmdRespTextAndOK(atHandle, rspBuf);
            break;
        }
        case AT_SET_REQ:
    ...
    switch (operaType)
    {
        ...
        case AT_SET_REQ:
        {
            ...
            do
            {
                ...
                {
                    MG_UTILS_Memset(fileNameTemp, 0, 64 +1);
                    _open_at_get_file_name(node, fileNameTemp, 64);
                    MG_UTILS_Snprintf((u8 *)rspBuf, 128, "+FSLSTFILE:%s", fileNameTemp);
