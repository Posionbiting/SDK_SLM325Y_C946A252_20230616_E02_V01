...
#define __CURRENT_FILE_NAME__ mg_openAT_param
#define __EC618 1
#define CHIP_EC618 1
#define CORE_IS_AP 1
...
s32 mg_openAT_cmdParamUintInRange(AtParamValueCP pAtParaList, u32 index, s32 minValue, s32 maxValue, s32 defaultValue, BOOL *result)
{
    ...
    *result = (iRet != AT_PARA_ERR) ? (((BOOL)1)) : (((BOOL)0));
    return (s32)nValue;
}
s32 mg_openAT_cmdParamStr(AtParamValueCP pAtParaList, u32 index, u8 *pOutStrBuf, u16 maxOutBufLen, BOOL *result)
{
    ...
    iRet = atGetStrValue(pAtParaList, (UINT32)index, (UINT8 *)pOutStrBuf, (UINT16)maxOutBufLen, &nLen, (CHAR *)((void *)0));
    *result = (iRet != AT_PARA_ERR) ? (((BOOL)1)) : (((BOOL)0));
    return (s32)nLen;
}
