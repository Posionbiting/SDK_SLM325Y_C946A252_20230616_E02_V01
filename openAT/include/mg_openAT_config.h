/**
  ******************************************************************************
  * @file    mg_openAT_config.h
  * @author  MEIG Development Team
  * @version V1.0.0
  * @date    28-Mar-2022
  * @brief   This file provides all openAT config.
  ******************************************************************************
  *  @attention
  *
...
#ifndef _MG_OPENAT_CONFIG_H_
#define _MG_OPENAT_CONFIG_H_

/* enable base at cmd */
#define  OPENAT_BASE_ENABLE         (1)

/* enable fs at cmd */
#define  OPENAT_FS_ENABLE           (1)
