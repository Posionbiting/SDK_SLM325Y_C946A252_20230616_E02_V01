...
//<!--[ODM][HTTP][MeigLink12296]zcxz@2023-02-16 Add application/json
//#define HTTPCFG_CONTENTTYPE_MAX                 3
#define HTTPCFG_CONTENTTYPE_MAX                 4
//end-->[ODM][HTTP][MeigLink12296]zcxz@2023-02-16 Add application/json
...
CmsRetId  httpLBS(const AtCmdInputContext *pAtCmdReq);
