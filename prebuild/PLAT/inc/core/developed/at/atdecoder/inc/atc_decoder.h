...
//<!--[ODM]cxz@2021-12-13 ADD
#ifdef FEATURE_MEIG_AT_ENABLE
    ATC_MEIG_INPUT_DATA_STATE,
#endif
//end-->

//<!--[ODM][TaskID 30320]FW@2021-12-23 add open at bypass mode.
...
//<!--[ODM]cxz@2021-12-13 ADD AT MEIG.
//#ifdef FEATURE_MEIG_AT_ENABLE
    const CHAR      *pName;
//#endif
//end-->
...
//<!--[ODM][TaskID 18014]hs@2021-12-07 ADD AT MEIG QHTTP.
//#ifdef FEATURE_MEIG_AT_ENABLE
...
//<!--[ODM][TaskID 29163]fw@2022-11-30 add open at
//#ifdef FEATURE_OPENCPU_AT_ENABLE
...
//<!--[ODM]cxz@2022-01-14 ADD
#ifdef FEATURE_MEIG_AT_ENABLE
typedef CmsRetId (*mgAt_atcChannelInDataCB_t)(AtChanEntityP pAtChanEty, UINT8 *pInput, UINT16 length, void *ctx);
typedef void (*mgAt_atcChannelAsyncCtxDestroy_t)(void **ctx);

typedef struct
{
    void                                *ctx;
    mgAt_atcChannelAsyncCtxDestroy_t    ctx_destroy;
}mgAt_async_ctx_t;

CmsRetId mgAt_atcChangeChannelToInput(UINT16 srcHandler, const char *promptStr,
                                                mgAt_atcChannelInDataCB_t inDataCB, mgAt_async_ctx_t *ctx);

#define mgAt_atcChangeChannelToCmd(chanId)      atcChangeChannelState(chanId, ATC_COMMAND_STATE)
#endif
//end-->
