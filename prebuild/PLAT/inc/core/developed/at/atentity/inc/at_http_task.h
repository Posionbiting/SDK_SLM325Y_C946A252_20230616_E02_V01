...
//<!--[ODM][LBS][Task33295]wj@2023-03-19 add EPH for Custom YS
#ifdef CONFIG_MG_CUSTOMER_YS
#define HTTP_RSP_CONTENT_BUFFER_SIZE     10000
#else
#define HTTP_RSP_CONTENT_BUFFER_SIZE     1501
#endif
//end-->

//<!--[ODM][LBS][Task18010]zcxz@2022-02-26 Add AT+LBS
#define HTTP_LBS_LONGTITUDE_LATITUDE_SIZE   20
//end-->[ODM][LBS][Task18010]zcxz@2022-02-26 Add AT+LBS
...
typedef enum {
    HTTPSTAT_CLOSE = 0,
    //<!--[ODM][BugID 36653]cxz@2022-09-15 add.
    HTTPSTAT_STOP,
    //end-->
    HTTPSTAT_CONNECT,
    HTTPSTAT_REQHANDL,
...
//<!--[ODM][LBS][Task33295]wj@2023-03-19 add EPH flag
    bool isEPH;
//end-->[ODM][LBS][Task33295]wj@2023-03-19 add EPH flg
    uint8_t dlUrcRag;
    bool cache2flash;
    bool postfile;
    char* postfilename;
