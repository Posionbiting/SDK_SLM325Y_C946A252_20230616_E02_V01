...
#define ATC_ECCFG_1_POWER_ATTACH_WITH_IMSI_VAL_MIN          (0)
#define ATC_ECCFG_1_POWER_ATTACH_WITH_IMSI_VAL_MAX          (1)
#define ATC_ECCFG_1_POWER_ATTACH_WITH_IMSI_VAL_DEFAULT      (1)
