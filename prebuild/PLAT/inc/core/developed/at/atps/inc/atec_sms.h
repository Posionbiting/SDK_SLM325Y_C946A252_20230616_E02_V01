...
*(C) Copyright 2018 EIGENCOMM Ltd.
...
#define ATC_TP_CAUSE_NO_SMS_STORAGE_CAPABILITY_IN_SIM   0xD1
#define ATC_TP_CAUSE_MEMORY_CAPACITY_EXCEEDED           0xD3
#define ATC_TP_CAUSE_UNSPECIFIED_ERR                    0xFF

#define ATC_SEND_RP_ACK                                 0
#define ATC_SEND_RP_ERROR                               2
 ...
 *****************************************************************************
******************************************************************************/
typedef struct AtecSmsCMSSinfoStr
{
    UINT8                 sendIndex;
    UINT8                 mem2Type;
