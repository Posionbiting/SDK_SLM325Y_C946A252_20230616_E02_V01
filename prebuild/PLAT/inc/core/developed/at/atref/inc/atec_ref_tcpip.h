...
//<!--[ODM][BugID 36133]cxz@2022-09-05 change CONNECT ID MAX.
#define QTCP_CONNECT_ID_MAX                      (9)
//end-->
...
//<!--[ODM][BugID 36133]cxz@2022-09-05 change CONNECT ID MAX.
#define QIOPEN_1_CONNECT_ID_MAX                  QTCP_CONNECT_ID_MAX
//end-->
...
//<!--[ODM][BugID 36133]cxz@2022-09-05 change CONNECT ID MAX.
#define QICLOSE_0_CONNECT_ID_MAX                 QTCP_CONNECT_ID_MAX
//end-->
...
//<!--[ODM][BugID 36133]cxz@2022-09-05 change CONNECT ID MAX.
#define AT_QIRD_0_CONNECTID_MAX          QTCP_CONNECT_ID_MAX
//end-->
...
//<!--[ODM][BugID 36133]cxz@2022-09-05 change CONNECT ID MAX.
#define AT_QISWTMD_0_CONNECTID_MAX          QTCP_CONNECT_ID_MAX
//end-->
...
//<!--[ODM][BugID 36133]cxz@2022-09-05 change CONNECT ID MAX.
#define AT_QISTATE_1_CONNECTID_MAX       QTCP_CONNECT_ID_MAX
//end-->
...
//<!--[ODM][BugID 36133]cxz@2022-09-05 change CONNECT ID MAX.
#define AT_QISENDEX_0_CONNECTID_MAX          QTCP_CONNECT_ID_MAX
//end-->
...
//<!--[ODM][BugID 36133]cxz@2022-09-05 change CONNECT ID MAX.
#define AT_QISEND_0_CONNECTID_MAX          QTCP_CONNECT_ID_MAX
//end-->
...
CmsRetId  nmQISENDHEX(const AtCmdInputContext *pAtCmdReq);
CmsRetId  nmQISWTMD(const AtCmdInputContext *pAtCmdReq);
CmsRetId nmQISocketInputData(UINT8 chanId, UINT8 *pInput, UINT16 length);
void     nmQISocketFreeSendInfo(void);
void     nmQISocketFreeDataBody();

AtRefSocketSndInfo *nmQIGetSendMsgHander(void);
CmsRetId  nmQNETDEVCTL(const AtCmdInputContext *pAtCmdReq);

CmsRetId nmQISocketInputPSTHData(UINT8 chanId, UINT8 *pInput, UINT16 length);
void     nmQISocketPSTHdataInit(UINT8 connectId, UINT16 reqHander);
//<!--[ODM][BugID 39715]huqing@2022-12-14 modify for AT+QIOPEN passthrough mode
void     nmQISocketPSTHdataFlush(void);
//end-->
//<!--[ODM][YY TCP][TaskID28998]hs@2022-12-15 add for LPC
#ifdef CONFIG_YY_LPC_SUPPORT
#define QUECTEL_IPCBUFF_MAX 256
typedef struct CmsRefLPCCfgParam_Tag
{
    CHAR ignore_buf[QUECTEL_IPCBUFF_MAX];
    UINT8 ignore_mode;
    UINT8 ignore_format;
    UINT32 auto_interval;
    CHAR auto_buf[QUECTEL_IPCBUFF_MAX];
    UINT8 auto_format;
    CHAR wake_buf[QUECTEL_IPCBUFF_MAX];
    UINT8 wake_format;
}CmsRefLPCCfgParam;  // 14 bytes
#endif
// end -->
