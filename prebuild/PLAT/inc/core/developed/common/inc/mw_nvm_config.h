...
#include "osacfgnvm.h"
#include "mw_common.h"
//<!--[ODM][MG NV]cxz@2022-11-25 add meig nv config
...
typedef enum MidWareCfgParamId_Enum
{
    ...
    MW_CFG_PPP_AUTH_SELECT_PARAM,       /* TLV, MWNvmCfgPppAuthSelectParam */

    /* ------Warning!!! ---------*/
    //<!--[ODM][MG NV]cxz@2022-11-25 add meig nv config
    MW_CFG_MG_SYS_PARAM,            /* TLV, MGNvmConfig */
    //end-->

//<!--[ODM][MeigLinkID 13160]ldw@2023-06-16 modify QCFG.
    MW_CFG_MG_URC_DELAY_PARAM,
//end-->
    /* ------Warning!!! if there are any updates, please add back, can't cut in line */
...
{
    /* Urc delay time after RI pulse done, in unit of ms. */
    UINT32      urcDelayMs[MID_WARE_USED_AT_CHAN_NUM];
}MGNvmCfgUrcDelayParam;         //16 bytes
//end-->
...
typedef struct MidWareNvmConfig_Tag
{
    ...
    */
    ...
    //<!--[ODM][MG NV]cxz@2022-11-25 add meig nv config
    MGNvmConfig mgSySParam; //MG system param
    //end-->
//<!--[ODM][MeigLinkID 13160]ldw@2023-06-16 modify QCFG.
    MGNvmCfgUrcDelayParam   mgUrcDelayParamCfg;      // 16 bytes
//end-->
}MidWareNvmConfig;
