...
//<!--[ODM][TaskID 18013]cxz@2021-12-13 ADD AT MEIG QSSL.
#ifdef FEATURE_YY_SSL_AT_ENABLE
    uint8_t ignorelocaltime;
    uint16_t negotiatetime;
    //uint8_t sni;
    char caCertexPath[SSL_CERTPATH_MAX_SIZE];
    char psk_identity[128];
    char psk_key[128];
    uint8_t closetimemode;
    uint8_t ignoremulticertchainverify;
    uint8_t ignoreinvalidcertsign;
#endif
//end-->
} sslAtContext_t;
