...
//<!--[ODM][TaskID 33292]ldw@2023-03-19 add AT+CCED
#ifdef MEIG_UNISOC_ENABLE
CmsRetId appGetECBCInfoSync_ys(BasicCellListInfo *pBcListInfo, UINT16 maxTimeout,UINT8 reqCellNum);
#endif
//end-->
