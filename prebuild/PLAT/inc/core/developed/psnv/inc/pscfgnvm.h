 ...
 * !!!!
*/
typedef enum PsConfigParamId_Enum
{
    PS_CFG_PARAM_BASE       = 0,
    ...
    //CERRC_CFG_R14_RAI_SUPPORT,                      /* TV,  BOOL bRaiSupport*/
    //CERRC_CFG_NB_R13_MULTI_CARRIER_SUPPORT,         /* TV,  BOOL bMultiCarrierSupport */
    //CERRC_CFG_NB_R13_MULTI_TONE_SUPPORT,            /* TV,  BOOL bMultiToneSupport */
    //CERRC_CFG_CELL_RESEL_ENABLE,                    /* TV,  BOOL bEnableCellResel */
    //CERRC_CFG_CONNECT_REEST_ENABLE,                 /* TV,  BOOL bEnableConnReEst */
    ...
    //CERRC_CFG_UE_POWER_CLASS_SETTING = 60,          /* TLV, PsCfgCerrcUePowerClassSetting */
 ...
 * +-------------------------------------------------------+
*/
typedef struct PsCfgPlmnSelectType_Tag
{
...
*/
typedef struct PsCfgCellLockInfo_Tag
{
    UINT8   bCellLock;
    UINT8   rsvd0;
...
*/
typedef struct PsCfgPlmnBandInfo_Tag
{
 ...
 * CEMM_CFG_UE_NW_CAPA
*/
typedef struct PsCfgCemmUeNwCapa_Tag
{
    UINT8   capaLen;
...
*/
typedef struct PsCfgCemmMsClassMark2_Tag
{
    UINT8   classmark2Len;
...
*/
typedef struct PsCfgCemmPsmSetting_Tag
{
...
*/
typedef struct PsCfgCemmEdrxSetting_Tag
{
...
*/
typedef struct PsCfgCemmUserMaxT3324Setting_Tag
{
...
*/
#pragma pack(2)
typedef struct PsCfgCemmCiotSetting_Tag
{
...
*/
typedef struct PsCfgCemmVoiceDomainUeUsage_Tag
{
    BOOL            present;
    UINT8           rsvd;
...
*/
typedef struct PsCfgCesmUserDefinedT3482_Tag
{
...
*/
typedef struct PsCfgCesmUserDefinedT3492_Tag
{
...
*/
typedef struct PsCfgUserDefinedHighPriPlmnTimer_Tag
{
...
*/
typedef struct PsCfgL2DataCounterInfo_Tag
{
