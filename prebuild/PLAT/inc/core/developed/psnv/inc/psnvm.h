...
*/
typedef struct CesmPdpDefinition_tag
{
...
typedef struct  CesmNvmPdpConfig_Tag
{
...
typedef struct CesmPdpAuthDefinition_Tag
{
...
typedef struct  CesmNvmPdpAuthConfig_Tag
{
