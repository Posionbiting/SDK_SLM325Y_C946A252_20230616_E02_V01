...
#include "dma.h"
#include "clock.h"
//<!--[ODM][TaskID 19021]hs@2022-01-05 ADD QFOTADL.
#include "mgversion.h"
//end-->

//<!--[ODM][TaskID17995]wbh@2022-01-12 Add led driver.
#include "led.h"
//end-->
...
//<!--[ODM][TaskID 19021]hs@2022-01-05 ADD QFOTADL.
#define SOFTVERSION     MEIG_AP_VERSION //"V"SDK_MAJOR_VERSION"."SDK_MINOR_VERSION"."SDK_PATCH_VERSION
//end-->
