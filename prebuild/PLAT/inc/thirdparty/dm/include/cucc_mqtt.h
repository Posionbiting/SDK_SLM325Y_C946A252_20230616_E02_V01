...
#define CUCC_DM_MQTT_USERNAME_LEN       50
#define CUCC_DM_MQTT_PASSWORD_LEN       66
#define CUCC_DM_MQTT_DEVICE_SECRET_LEN  66

#define CUCC_DM_MQTT_RECV_DEVICE_SECRET_LEN  166

int mqttCuccNoPreIdentity(const char *productKey, const char *deviceKey, char *clientId, char *username);
int mqttCuccDynNoPreRegIdentity(const char *productKey, const char *deviceKey, const char *productSecret, char *clientId, char *username, char *password);
