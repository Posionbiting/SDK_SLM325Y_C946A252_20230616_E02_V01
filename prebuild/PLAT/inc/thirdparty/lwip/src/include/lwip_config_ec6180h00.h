/**
* the LWIP configuration file of ec6180h00 project
**/


#if !defined LWIP_HDR_CONFIG_H
...
#if !defined ENABLE_PSIF || defined __DOXYGEN__
#define ENABLE_PSIF                          1
#endif

/*
*define PS netif MTU size
*/

#if !defined PS_NETIF_DEFAULT_MTU || defined __DOXYGEN__
#define PS_NETIF_DEFAULT_MTU                 1500
#endif

/*
*define LAN netif MTU size
*/
...
#if defined ENABLE_PSIF
/*
 * EC618 use: "LWIP_USE_PS_DL_PKG_MEM", not "PBUF_POOL_MM_USE_CUSTOM"
*/
#define PBUF_POOL_MM_USE_CUSTOM         0

#define PS_MM_POOL_SIZE                 (4*PS_NETIF_DEFAULT_MTU)    //used for DL IP PKG, 4*1400 = 5600 bytes
#define PS_MM_UL_MAX_TOTAL_BUFFER_SIZE  8*1024   //used for UL IP PKG, control the total UL pkg buffer, just system dynamic heap memory
#define PS_UL_MEM_MAGIC_CHECK           1
#define PS_MM_LIST_DEBUG_ENABLE         1

#define PS_ENABLE_TCPIP_HIB_SLEEP2_MODE 1

//define whether enable lwip unilog
#define LWIP_ENABLE_UNILOG 1

//define whether enable lwip timer on demand or not
#define LWIP_TIMER_ON_DEMOND 1

#define LWIP_TIMEVAL_PRIVATE 1

//define whether pending raw/udp UL data when PS UL suspend enable
...
//whether enable debug tcp pcb list
...
/*define whether enable ipv6 address DAD check*/
...
#define PBUF_POOL_MM_USE_CUSTOM_ADD_MAGIC_CHECK 1
#define PBUF_POOL_MM_USE_CUSTOM_DEBUG 1
#endif
 ...
 */
#if !defined TCPIP_IGMP
#if !defined LWIP_IGMP || defined __DOXYGEN__
#define LWIP_IGMP                       0
#endif
#else
#define LWIP_IGMP TCPIP_IGMP
#endif
...
/** DNS retry timeout timer ms */
#if !defined DNS_TMR_INTERVAL || defined __DOXYGEN__
...
/**
 * TCP_MINRTX: Minimum number of TCP retry time init value.(ms)
 */
#if !defined TCP_MINRTX || defined __DOXYGEN__
#define TCP_MIN_INIT_RTX                      5
#endif

/**
 * TCP_DEFRTX: default number of TCP retry time init value.(ms)
 */
#if !defined TCP_DEFRTX || defined __DOXYGEN__
#define TCP_MAX_INIT_RTX                      50000
#endif


/**
 * TCP_MINRTX: Minimum number of retransmissions of data segments.
 */
#if !defined TCP_MINRTX || defined __DOXYGEN__
#define TCP_MINRTX                      4
#endif
...
/**
 * TCP_DEFRTX: default number of retransmissions of data segments.
 */
#if !defined TCP_DEFRTX || defined __DOXYGEN__
#define TCP_DEFRTX                      6
#endif
...
/**
 * TCP_MAXRTX_TOTAL_TIME: Maximum total time of retransmissions of data segments.(seconds)
 */
#if !defined TCP_MAXRTX_TOTAL_TIME || defined __DOXYGEN__
#define TCP_MAXRTX_TOTAL_TIME                      600
#endif

/**
 * TCP_MINRTX_TOTAL_TIME: Minimum total time of retransmissions of data segments.(seconds)
 */
#if !defined TCP_MINRTX_TOTAL_TIME || defined __DOXYGEN__
#define TCP_MINRTX_TOTAL_TIME                      40
#endif

/**
 * TCP_DEFRTX_TOTAL_TIME: DEFAULT total time of retransmissions of data segments.(seconds)
 */
#if !defined TCP_DEFRTX_TOTAL_TIME || defined __DOXYGEN__
...
*tcp TMR timer
*/
#if !defined TCP_TMR_INTERVAL || defined __DOXYGEN__
...
/**
*tcp fast start timer
*/
#if !defined TCP_FAST_INTERVAL || defined __DOXYGEN__
#define TCP_FAST_INTERVAL TCP_TMR_INTERVAL
#endif

/**
*tcp slow start timer
*/
#if !defined TCP_SLOW_INTERVAL || defined __DOXYGEN__
...
/*LWIP API SEMPHORE PER operation */
#if !defined LWIP_NETCONN_SEM_PER_OPERATION || defined __DOXYGEN__
...
#define RECV_BUFSIZE_DEFAULT            (6 * 1024) //INT_MAX
#endif
 ...
 */
#if defined TCPIP_MLD6
#define LWIP_IPV6_MLD TCPIP_MLD6
#else
...
/**
 * LWIP_ND6_RTR_SOLICITATION_INTERVAL: the router solicitation message interval(seconds)
 */
#if !defined LWIP_ND6_RTR_SOLICITATION_INTERVAL || defined __DOXYGEN__
...
#define LWIP_ND6_NS_RETRY_TIME 3000 //ms
#endif
